...
export async function preflight() {
  ...
  checks.push({
    ...
    detail: Array.isArray(avds)
      ...
      : String(avds),
    fix:
      "Create an emulator in Android Studio Device Manager or call android_create_avd " +
...
function readyDevices(value: unknown): { state: string }[] {
