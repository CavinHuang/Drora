...
import type { DynamicWorkflowRunProgressPayload, Logger, SessionId } from "@drora/contracts";
 ...
 *
 *   DroraApp ──1:1── AgentRuntime ──1:1── sessionId        （create-app：`new AgentRuntime(sessionId, …)`）
