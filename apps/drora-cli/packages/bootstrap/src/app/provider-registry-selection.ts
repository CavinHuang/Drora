import { ModelErrorCode, ModelProtocolError } from "@drora/contracts";
import {
...
function toModelOption(provider: Provider, model: ProviderModel): DroraModelOption {
