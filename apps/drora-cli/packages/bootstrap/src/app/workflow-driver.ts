...
// ============================================================
// 把 dynamic-workflow 引擎核心的向下副作用端口 WorkflowDriver 落到真实 Drora AgentRuntime 上：
...
import type { SessionId, WorkflowEscalatePort } from "@drora/contracts";
import type { TurnResult } from "@drora/core";
import {
