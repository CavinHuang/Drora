...
import { createNodeExecutionAdapter } from "@drora/adapters/exec";
...
import type { PrepareUserExecutionBoundary, DroraAppOptions } from "./types.js";
...
function createWorkflowChildRuntime(
  ...
  return new AgentRuntime(
    ...
    {
      ...deps.runtimeConfig,
      agentName: options.workflowKind === "expert" ? "drora-expert" : "drora-workflow",
      mode: "yolo",
    ...
    },
    {
      ...
      ...deps.runtime.createChildClientPorts({
        ...
        agentType: options.workflowKind === "expert" ? "drora-expert" : "drora-workflow",
