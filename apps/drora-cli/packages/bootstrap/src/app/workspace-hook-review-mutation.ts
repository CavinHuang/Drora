...
import { digestSummary, workspaceIdentitySummary } from "@drora/core";
import {
...
} from "@drora/shared/workspace-hook-mutation";
...
export function createWorkspaceHookReviewMutationPort(
  ...
  const editableConfigPath = resolve(workingDirectory, ".drora", "config.json");
