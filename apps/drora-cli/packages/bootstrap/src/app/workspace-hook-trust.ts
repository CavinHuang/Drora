import { createDefaultFileWorkspaceHookTrustStore } from "@drora/adapters/storage";
import {
...
import type { WorkspaceHookRuntimeRoot } from "@drora/shared/workspace-hook-discovery";
import {
...
export function createWorkspaceHookRuntimeSecurity(input: {
  ...
  /** 测试注入临时 HOME；生产不传，Trust store 落在真实 ~/.drora/security。 */
  homeDir?: string;
