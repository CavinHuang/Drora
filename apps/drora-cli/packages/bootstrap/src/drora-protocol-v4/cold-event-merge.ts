...
interface PersistedConversationMaterializationStore {
  getSession(sessionId: import("@drora/contracts").SessionId): Promise<{
    title?: string;
    revert?: {
      branchCutAfterMessageID?: import("@drora/contracts").MessageId;
      branchGeneration?: number;
      createdMessageID?: import("@drora/contracts").MessageId;
      keptMessageIDs?: import("@drora/contracts").MessageId[];
      targetMessageID?: import("@drora/contracts").MessageId;
    };
  } | null>;
  messages(input: { sessionID: import("@drora/contracts").SessionId }): Promise<MessageWithParts[]>;
  readTarget(input: {
    sessionID: import("@drora/contracts").SessionId;
...
export async function loadPersistedConversationMaterialization(input: {
  ...
  const sessionID = input.sessionId as import("@drora/contracts").SessionId;
