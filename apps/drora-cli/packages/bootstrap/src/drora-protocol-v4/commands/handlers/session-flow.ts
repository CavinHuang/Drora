...
import { createModelExecutionContext } from "../../../drora-protocol/model-execution.js";
...
import type { TurnAttachment } from "@drora/core";
...
async function stop(
  ...
  host.logger?.info?.("v4 stop foreground execution inspected", {
    ...
    expectedForegroundExecutionId: payload.expectedForegroundExecutionId,
    module: "bootstrap.drora_protocol_v4.commands",
...
import { resolveExecutionState } from "@drora/shared";
