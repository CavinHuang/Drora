import {
  droraProviderUpdateAccountConfigParamsSchema,
  type DroraProviderUpdateAccountConfigResult,
} from "@drora/shared";
...
export async function updateAccountProviderConfig(
  ...
  params: unknown,
): Promise<DroraProviderUpdateAccountConfigResult> {
  const envelope = parseParams(droraProviderUpdateAccountConfigParamsSchema, params);
