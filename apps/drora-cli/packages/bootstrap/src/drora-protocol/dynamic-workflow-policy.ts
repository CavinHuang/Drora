import { droraWorkspaceUpdateDynamicWorkflowPolicyParamsSchema } from "@drora/shared";
...
export async function updateDynamicWorkflowPolicy(
  ...
  const params = parseParams(droraWorkspaceUpdateDynamicWorkflowPolicyParamsSchema, rawParams);
