import { droraWorkspaceUpdateInteractionPreferencesParamsSchema } from "@drora/shared";
...
export async function updateInteractionPreferences(
  ...
  const params = parseParams(droraWorkspaceUpdateInteractionPreferencesParamsSchema, rawParams);
