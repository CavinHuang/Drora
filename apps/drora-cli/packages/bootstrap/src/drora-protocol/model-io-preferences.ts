import { droraWorkspaceUpdateModelIoPreferencesParamsSchema } from "@drora/shared";
...
export async function updateModelIoPreferences(
  ...
  const params = parseParams(droraWorkspaceUpdateModelIoPreferencesParamsSchema, rawParams);
