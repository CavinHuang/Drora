import { droraWorkspaceUpdateOffPeakToolPolicyParamsSchema } from "@drora/shared";
...
export async function updateOffPeakToolPolicy(
  ...
  const params = parseParams(droraWorkspaceUpdateOffPeakToolPolicyParamsSchema, rawParams);
