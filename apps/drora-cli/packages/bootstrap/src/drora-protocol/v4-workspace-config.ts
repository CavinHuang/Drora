...
import { getDroraAgentModeSelectOptions, normalizeAvailableDroraMode } from "@drora/shared";
import type { DroraSessionSettingsState, DroraSlashCommand } from "@drora/shared";
import type { WorkspaceConfigState } from "@drora/shared/drora-protocol-v4";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpDroraAgent 的注释）。
