import { parseRemoteWorkspaceIdentity, type DroraWorkspaceRef } from "@drora/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): DroraWorkspaceRef {
