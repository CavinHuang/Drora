import type { PermissionOptionsPolicy, PermissionUpdate } from "@drora/contracts";
import { OFFICIAL_CUA_PERMISSION_RULE_TOOL_NAME, type DroraPermissionOption } from "@drora/shared";
...
export function buildProtocolPermissionOptions(
  ...
  return [
    ...
    // **没有** permissionUpdates——wire 上 droraPermissionUpdateSchema 是 strict，会话语义由
