...
- IAB tabs persist for the lifetime of the current Drora process. Turn end, session end, an omitted finalize call,
...
- Drora does not restore these tabs after the Drora process exits.
