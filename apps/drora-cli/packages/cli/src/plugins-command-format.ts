import { formatJson } from "@drora/core";
import type { GlobalOptions, JsonValue, RunContext } from "@drora/shared-types";
import type {
...
export function formatHumanAvailableList(plugins: readonly DroraAvailablePluginData[]): string {
...
export function formatHumanMarketplaceList(
  marketplaces: readonly DroraMarketplaceSummaryData[],
): string {
...
export function formatHumanPluginSet(result: SetDroraPluginEnabledResult): string {
...
export const formatPluginSetJson = (result: SetDroraPluginEnabledResult): string =>
  formatJson({
...
export function formatAvailablePluginJson(plugin: DroraAvailablePluginData) {
  return {
    id: plugin.id,
...
export function formatInstalledPluginJson(plugin: DroraInstalledPluginData) {
  return {
    enabled: plugin.enabled,
    id: plugin.id,
    marketplace: plugin.marketplace,
...
export function formatMarketplaceJson(marketplace: DroraMarketplaceSummaryData) {
  return {
    id: marketplace.id,
