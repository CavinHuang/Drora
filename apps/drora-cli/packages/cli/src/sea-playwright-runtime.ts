...
import type { PlaywrightChromiumModule } from "@drora/adapters/browser";
...
const ASSET_PREFIX = "drora-playwright-runtime/";
...
export async function loadCliPlaywrightChromium(): Promise<PlaywrightChromiumModule> {
  ...
  const require = createRequire(join(runtimeDirectory, "drora-playwright-loader.cjs"));
