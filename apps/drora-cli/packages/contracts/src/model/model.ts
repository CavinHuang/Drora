...
import { modelSelectionSchema, type ModelSelection } from "@drora/shared/model-selection";
import type { ModelPropertiesData, ModelOptionSpecsData } from "@drora/shared/model-config";

export type { ModelSelection } from "@drora/shared/model-selection";
...
} from "@drora/shared/model-config";
