...
} from "@drora/contracts/browser-control";
...
const locatorDetails = Symbol("drora.playwright.locatorDetails");
const setObjectWrapper = Symbol("drora.playwright.setObjectWrapper");
