...
import type { EnvInfo } from "@drora/contracts";
...
export function buildExploreAgentPrompt(options: ExploreAgentPromptOptions): string {
  ...
  return [
    "You are Drora Explore, a file search and codebase research specialist for Drora CLI. You excel at thoroughly navigating and exploring codebases.",
    "",
