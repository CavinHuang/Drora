...
export const enUS: DroraCopy = {
  ...
  cli: {
    ...
    help: (version) => `drora ${version}

Usage:
  drora [command] [options]

With no command, drora opens the full-screen TUI.

Commands:
  app-server Run the Drora Protocol stdio app server
...
`,
  ...
  tui: {
    ...
    terminal: {
      ...
      starting: "Starting Drora... Ctrl+C to exit",
    },
    transcript: {
      compact: {
