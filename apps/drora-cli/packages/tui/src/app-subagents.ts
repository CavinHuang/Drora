...
import { SessionEventType, type SessionEvent } from "@drora/contracts";
import type {
...
export type SubagentItem = DroraSessionRunningSubagent | DroraSessionEndedSubagent;
const EMPTY_DIRECTORY: DroraSessionSubagentsResult = {
  revision: 0,
  childSessionIds: [],
  running: [],
  ended: { total: 0, items: [] },
