import type { ModelUsageSummary, TodoItem, TurnId } from "@drora/contracts";
import { getDroraCopy } from "@drora/i18n";
...
export function TuiApp({
  ...
  const initialCopy = getDroraCopy(initialLocale).tui;
  ...
  const copy = useMemo(() => getDroraCopy(locale), [locale]);
