...
/**
 * 为 macOS 本地 Dev runtime 写入产品身份和 drora URL scheme。
 * raw Electron 的 Info.plist 没有 CFBundleURLTypes，系统只能把 drora 交给
...
export async function prepareDevElectronAppBundle({
  ...
  const sourceStampPath = join(dirname(appPath), ".drora-dev-electron-source.json");
