...
const shouldSkipRemoteAssets = process.env.DRORA_SKIP_REMOTE_ASSETS === "1";
...
if (!shouldSkipRemoteAssets) {
  ...
  console.log("[prepare:runtime-assets] skip prepare:remote-assets (DRORA_SKIP_REMOTE_ASSETS=1)");
}
