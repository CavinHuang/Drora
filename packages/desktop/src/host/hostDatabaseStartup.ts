import {
  ...
  resolveDroraAgentSpawnCwd,
} from "@drora/services/storage-startup";
import type { DatabaseStartupState } from "@drora/shared";
    ...
    prepare: async (report) => {
      ...
      try {
        ...
        for (const candidate of candidates) {
          ...
          const { cwd } = await resolveDroraAgentSpawnCwd({
