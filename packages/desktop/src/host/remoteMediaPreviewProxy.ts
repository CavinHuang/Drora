...
import type { IFileService, IMediaPreviewService, MediaPreviewPreparation } from "@drora/services";
import { getMediaPreviewFormat, type WindowHostAttachmentScope } from "@drora/shared";
import {
...
const MEDIA_ROUTE_PREFIX = "/__drora_media/";
