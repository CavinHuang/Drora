...
import type { ProviderProvisioningResult } from "@drora/shared";
import type { IProviderProvisioningTargetService, IServiceAccessor } from "@drora/services";
import {
  getProviderProvisioningSource,
  type ProviderProvisioningSource,
} from "@drora/services/node";
import type { ServiceCollection } from "@drora/services";
