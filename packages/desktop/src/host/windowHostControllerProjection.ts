...
import type { DroraArchivedTaskDeletionResult } from "@drora/services";
import {
...
export interface WindowHostControllerSessionOverlay {
  ...
  updatedAt?: number;
  pendingInteraction?: DroraTaskMeta["pendingInteraction"];
...
export type WindowHostControllerMutationResult = void | boolean | DroraArchivedTaskDeletionResult;
...
function defaultLiveStatus(meta: DroraTaskMeta): WindowHostControllerTaskRow["liveStatus"] {
