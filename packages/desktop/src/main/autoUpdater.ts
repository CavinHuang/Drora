...
const DEV_AUTO_UPDATE_VERSION_SWITCH = "--drora-auto-update-dev-version";
...
type UpdateDownloadedInfoLike = {
  ...
  droraReleaseChannel?: ElectronReleaseChannel | null;
...
function readUpdateInfoReleaseChannel(
  ...
  return info.droraReleaseChannel === "preview" || info.droraReleaseChannel === "stable"
    ? info.droraReleaseChannel
    : null;
}
