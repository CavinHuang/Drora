...
import type { BrowserPlaywrightAction, BrowserPlaywrightModifier } from "@drora/shared";
...
const PLAYWRIGHT_WORLD_NAME = "drora-playwright-locator";
const PLAYWRIGHT_GLOBAL = "__droraPlaywrightInjected";
