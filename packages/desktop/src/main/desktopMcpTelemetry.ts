...
function mapMcpTelemetryEvent(event: Exclude<DroraMcpTelemetryEvent, { kind: "memory" }>): {
...
function processProperties(
  event: Extract<DroraMcpTelemetryEvent, { kind: "process_start" | "process_crash" }>,
