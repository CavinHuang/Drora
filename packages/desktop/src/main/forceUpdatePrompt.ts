...
function buildForceUpdatePromptMessages(locale: Locale) {
  ...
  return {
    ...
    checkingMessage: "Keep this window open while Drora checks for updates.",
    downloadingTitle: "Downloading update",
    downloadingVersionTitle: "Downloading update v{version}",
    downloadingMessage: "Drora will install the update automatically after download.",
    readyTitle: "Update downloaded",
    readyMessage: "Drora is preparing to restart and install the update.",
    installingTitle: "Installing update",
    installingMessage: "Drora will restart to finish installing the update.",
    ...
    <main class="panel" role="dialog" aria-modal="true" aria-labelledby="title">
      <header class="titlebar">
        <div class="brand">
          ...
          <div class="brand-title">Drora</div>
        </div>
