...
function buildLegacyCommonMcpStorageCandidates(request?: MigrateLegacyCommonMcpRequest): string[] {
  ...
  candidates.push(join(appData, "ai.z.drora", "store.json"));

  candidates.push(
    join(localAppData, "ai.z.work", "EBWebView", "Default", "Local Storage", "leveldb"),
    join(appData, "Drora", "Local Storage", "leveldb"),
    join(appData, "Drora", "Partitions", "drora-embedded-browser", "Local Storage", "leveldb"),
    join(appData, "Drora Dev", "Local Storage", "leveldb"),
    join(appData, "Drora Dev", "Partitions", "drora-embedded-browser", "Local Storage", "leveldb"),
  );
