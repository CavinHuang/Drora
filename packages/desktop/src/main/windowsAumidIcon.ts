...
import type { ApplicationIconInfo } from "@drora/shared";
...
public static class DroraAumidIcon {
...
'@;
$droraIconBytes=[DroraAumidIcon]::Read($droraArg0);
[Console]::Out.Write([Convert]::ToBase64String($droraIconBytes));
`;
