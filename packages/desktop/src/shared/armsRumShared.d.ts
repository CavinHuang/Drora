import { type DroraRuntimeEnv } from "@drora/shared";
...
export declare function buildArmsBrowserInitConfig(runtimeEnv: DroraRuntimeEnv): {
  enable: boolean;
  version: string;
  endpoint: string;
  env: import("@drora/shared").ArmsRumEnv;
  sessionConfig: {
    sampleRate: number;
  };
  spaMode: false;
