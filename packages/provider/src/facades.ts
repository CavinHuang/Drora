...
export class ProviderSettingsFacade {
  ...
  getView(): ProviderSettingsView {
    ...
    return createProviderSettingsView({
      ...
      droraBuiltinProviders: snapshot.config.droraBuiltinProviders,
      droraBuiltinProviderTemplates: snapshot.config.droraBuiltinProviderTemplates,
  ...
  resolveModelConfig(input: ResolveModelConfigInput): ModelConfigResolution {
    ...
    if (!("personalConfig" in input)) {
      const modelRules = ModelConfigRules.composeEffective(
        snapshot.config.droraBuiltinModelRules,
    ...
    const inheritedConfig = snapshot.config.droraBuiltinModelRules.resolve({
      providerId: input.providerId,
      templateId: provider.templateId,
      modelId: input.modelId,
      apiType: provider.config.api?.type,
...
function createProviderSettingsView(input: {
  revision: number;
  droraBuiltinProviders: ProviderRegistryServiceSnapshot["config"]["droraBuiltinProviders"];
  droraBuiltinProviderTemplates: ProviderRegistryServiceSnapshot["config"]["droraBuiltinProviderTemplates"];
  ...
  return Object.freeze({
    ...
    providerTemplates: Object.freeze(
      (input.droraBuiltinProviderTemplates ?? ProviderTemplateMap.empty())
        .entries()
