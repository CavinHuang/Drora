...
export class ProviderRegistryService {
  ...
  async #runRefreshLoop(): Promise<void> {
    ...
    while (this.#completedGeneration < this.#requestedGeneration) {
      ...
      if (account.basedOnDroraBuiltinRevision !== config.droraBuiltinRevision) {
      ...
      try {
        const resolution = this.#resolver.resolve({
          droraBuiltinProviders: config.droraBuiltinProviders,
          droraBuiltinProviderTemplates: config.droraBuiltinProviderTemplates,
          personalProviders: config.personalProviders,
          droraBuiltinModelRules: config.droraBuiltinModelRules,
