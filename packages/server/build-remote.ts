...
const buildResult = await build({
  ...
  bundle: true,
  outfile: "dist/remote/drora-server.cjs",
  platform: "node",
  format: "cjs",
  target: "node22",
...
const remoteBundleSource = readFileSync("dist/remote/drora-server.cjs", "utf-8");
...
console.log("Built dist/remote/drora-server.cjs");
