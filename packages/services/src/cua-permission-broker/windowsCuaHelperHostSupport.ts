...
import { HELPER_ADDON_ENV, WINDOWS_DEV_CONTROL_PROTOCOL } from "@drora/drora-cua/broker/server";
...
/**
 * Parse a `drora-cua-windows-dev/v1` control message from the helper child.
 *
