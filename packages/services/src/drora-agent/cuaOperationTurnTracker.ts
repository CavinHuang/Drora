import { resolveWorkspaceKey, type DroraComputerUseOperationEvent } from "@drora/shared";
...
interface CuaOperationTurnTracker {
  accept(workspace: CuaOperationWorkspaceTarget, event: DroraComputerUseOperationEvent): void;
...
export function createCuaOperationTurnTracker(options: {
  ...
  function accept(
    workspace: CuaOperationWorkspaceTarget,
    event: DroraComputerUseOperationEvent,
  ): void {
