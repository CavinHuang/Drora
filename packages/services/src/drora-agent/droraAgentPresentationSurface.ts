import type { ServiceAuthorityMode } from "@drora/shared";

export type DroraAgentPresentationSurface = "desktop";

interface DroraAgentPresentationHostFacts {
...
export function resolveDroraAgentPresentationSurface(
  facts: DroraAgentPresentationHostFacts,
): DroraAgentPresentationSurface | undefined {
