import { requestPluginReferenceCatalog } from "#src/drora-agent/pluginReferenceCatalogRequest.js";
import {
  localTtftFactsSchema,
  sessionDebugSnapshotSchema,
  type LocalTtftFacts,
} from "@drora/shared";
/* oxlint-disable eslint(max-lines) -- Drora Protocol transport、通知 wiring 和 app-facing session 方法必须共享同一个 client/emitter 上下文。 */
...
import { completeNewModelSelection } from "@drora/provider";
import type { OffPeakClientConfig } from "#src/coding-plan-subscription/codingPlanSubscription.js";
import {
  DRORA_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
  formatLogPrefix,
  resolveWorkspaceKey,
  type TraceId,
  DRORA_AGENT_PROVIDER,
  DRORA_AGENT_PROVIDER_NOT_READY_CODE,
  DRORA_AGENT_PROVIDER_NOT_READY_REASON,
  DRORA_MODEL_REASONING_SEPARATOR,
  isRemoteWorkspaceIdentity,
  DRORA_PROTOCOL_NAME,
  DRORA_PROTOCOL_VERSION,
  droraMcpListResultSchema,
  droraPermissionRequestParamsSchema,
  droraBrowserListParamsSchema,
  droraBrowserExecuteParamsSchema,
  droraPluginsConfigureResultSchema,
  droraPluginsInstallResultSchema,
  droraPluginsListResultSchema,
  droraPluginsMarketplaceMutationResultSchema,
  droraPluginsOverviewResultSchema,
  droraProcessChildProcessesResultSchema,
  type DroraProcessChildProcess,
  droraSkillsReferenceCatalogResultSchema,
  droraWorkflowsDeleteResultSchema,
  droraWorkflowsGetResultSchema,
  droraWorkflowsListResultSchema,
  droraWorkflowsMoveResultSchema,
  droraWorkflowsRunsResultSchema,
  droraWorkflowsUpdateMetaResultSchema,
  droraPluginsResolveSuggestedReferenceResultSchema,
  droraPluginOperationProgressNotificationSchema,
  droraPluginsRestoreBuiltinResultSchema,
  droraPluginsSetEnabledResultSchema,
  droraPluginsCancelOperationResultSchema,
  droraPluginsUninstallResultSchema,
  droraPluginsValidateResultSchema,
  droraPluginsDescribeResultSchema,
  droraAutomationCheckTaskBindingParamsSchema,
  droraAutomationCreateParamsSchema,
  droraAutomationDeleteParamsSchema,
  droraAutomationListParamsSchema,
  droraAutomationUpdateParamsSchema,
  droraOffPeakCreateParamsSchema,
  droraOffPeakListParamsSchema,
  OFF_PEAK_PROVIDER_IDS,
  droraComputerUseOperationEventSchema,
  droraProviderRuntimeHeadersCancelledSchema,
  droraProviderRuntimeHeadersRequestParamsSchema,
  droraProviderTestModelConnectivityResultSchema,
  droraOfficialMcpAuthHeadersRequestParamsSchema,
  summarizeOfficialMcpIdentityHeaders,
  droraProtocolEmptyResultSchema,
  droraProtocolMethods,
  droraProtocolNotifications,
  droraMcpTelemetryEventSchema,
  droraMcpResourceSamplesSchema,
  droraToolExecResourceSchema,
  droraProcessResourceSampleSchema,
  droraSessionCloseResultSchema,
  droraSessionCompactResultSchema,
  droraSessionEventsResultSchema,
  droraSessionGoalResultSchema,
  droraSessionListResultSchema,
  droraSessionSubagentsResultSchema,
  droraSessionMessagesResultSchema,
  droraSessionEventSchema,
  droraSessionSendResultSchema,
  droraSessionRequestRuntimePreferencesParamsSchema,
  droraSessionRuntimePreferencesResultSchema,
  droraSessionStateSnapshotSchema,
  droraSessionSubscribeResultSchema,
  droraStateUpdatedNotificationSchema,
  droraUserInputRequestParamsSchema,
  droraWorkspacePresentationSchema,
  droraWorkspaceCancelGenerateTextResultSchema,
  droraWorkspaceGenerateTextResultSchema,
  droraWorkspaceHookTrustGrantResultSchema,
  droraWorkspaceUpdateInteractionPreferencesResultSchema,
  droraWorkspaceUpdateModelIoPreferencesResultSchema,
  droraProviderUpdateAccountConfigResultSchema,
  type DroraSessionStateSnapshot,
  type DroraAutomation,
  type DroraAutomationRun,
  droraWorkspaceUpdateOffPeakToolPolicyResultSchema,
  droraWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
  type DynamicWorkflowClientConfig,
  type AgentLaneResourceSample,
  type ProcessResourceCliLane,
  type DroraMcpTelemetryEvent,
  type DroraMcpResourceSample,
  type DroraToolExecResource,
  type DroraPluginOperationProgressNotification,
  type DroraTaskMode,
} from "@drora/shared";
...
import { DRORA_AGENT_RUNTIME_UNAVAILABLE_CODE } from "./droraAgent.js";
import type {
  DroraProtocolRequestId,
  ModelSelection,
  DroraProviderRuntimeHeadersRequestParams,
  DroraSessionEvent,
  DroraSessionRuntimePreferencesScope,
  DroraSavedWorkflowScope,
...
import type {
  IDroraAgentService,
  DroraAgentBackgroundBashOutputParams,
  DroraAgentAppRuntimePreferences,
  DroraAgentRuntimeLifecycleEvent,
  DroraAgentAddPluginMarketplaceParams,
  DroraAgentAppUsageParams,
  DroraAgentCancelPluginOperationParams,
  DroraAgentCompactParams,
  DroraAgentConfigurePluginParams,
  DroraAgentResetPluginConfigParams,
  DroraAgentCreateSessionParams,
  DroraAgentInstallPluginParams,
  DroraAgentGenerateWorkspaceTextParams,
  DroraAgentTestModelConnectivityParams,
  DroraAgentGoalParams,
  DroraAgentGrantWorkspaceHookTrustParams,
  DroraAgentInitializeResult,
  DroraAgentListSessionsParams,
  DroraAgentListSessionSubagentsParams,
  DroraAgentReadWorkspacePresentationParams,
  DroraAgentReadSessionEventsParams,
  DroraAgentReadSessionMessagesParams,
  DroraAgentReadSessionParams,
  DroraAgentRemovePluginMarketplaceParams,
  DroraAgentRespondSessionRuntimePreferencesParams,
  DroraAgentResumeSessionParams,
  DroraAgentSendPromptParams,
  DroraAgentServiceEvent,
  DroraAgentSessionSubscribeParams,
  DroraAgentSessionTarget,
  DroraAgentSessionRuntimePreferencesRequest,
  DroraAgentTaskTokenUsageParams,
  DroraAgentSetModeParams,
  DroraAgentSetModelParams,
  DroraAgentSetPluginEnabledParams,
  DroraAgentSetThoughtLevelParams,
  ...
  DroraAgentCuaPermissionObservation,
  ...
  DroraAgentAttachmentBeginParams,
  DroraAgentAttachmentChunkParams,
  DroraAgentAttachmentReadParams,
  DroraAgentConversationAttachmentReadParams,
  DroraAgentConversationAttachmentStatParams,
  DroraAgentAttachmentPreviewSourceParams,
  DroraAgentAttachmentTerminalParams,
  DroraAgentConversationCommandParams,
  DroraAgentCommandsQueryParams,
  DroraAgentConversationFileChangesParams,
  DroraAgentConversationFileRewindPreviewParams,
  DroraAgentConversationRowsRangeParams,
  DroraAgentConversationPlansParams,
  DroraAgentConversationWorkflowRunEventsParams,
  DroraAgentConversationWorkflowRunArtifactDataParams,
  DroraAgentConversationWorkflowRunArtifactReadParams,
  DroraAgentConversationWorkflowRunArtifactsParams,
  DroraAgentConversationWorkflowRunNodeResultParams,
  DroraAgentConversationWorkflowRunWorkspaceParams,
  DroraAgentConversationWorkflowRunsParams,
  DroraAgentConversationResyncParams,
  DroraAgentConversationSubscribeParams,
  DroraAgentConversationUnsubscribeParams,
  DroraAgentConnectionFlowParams,
  DroraAgentSessionsIndexSubscribeParams,
  DroraAgentWorkspaceConfigSubscribeParams,
} from "./droraAgent.js";
import {
  ...
  utf8JsonByteLength,
  DRORA_ATTACHMENT_FAULT_CODES,
  DroraAttachmentFaultError,
  type CommandAck,
...
import {
  readTrustedDroraAgentV4Connection,
  readTrustedDroraAgentV4UnsubscribeRoute,
  type DroraAgentV4ConnectionContext,
} from "./droraAgentConnectionScope.js";
import { createBackgroundSessionEventCoalescer } from "#src/drora-agent/droraSessionEventCoalescer.js";
...
import { DroraAgentMcpStatusModeUnsupportedError } from "#src/drora-agent/droraAgentErrors.js";
import { DroraAgentProcessManager } from "./droraAgentProcessManager.js";
import type { DroraAgentProcessManagerOptions } from "./droraAgentProcessManager.js";
import type { IOffPeakTaskService } from "#src/session/offPeakTask.js";
import {
  DroraProtocolRequestTimeoutError,
  type DroraProtocolClient,
} from "./droraProtocolClient.js";
import { getDataBaseDir } from "../paths.js";
import {
  collectBrowserAmbientContext,
  type BrowserAmbientContextExecutor,
} from "./droraAgentBrowserAmbientContext.js";
import {
...
import type { PipSessionEvent } from "@drora/drora-cua/pip-session";
import { registerMemoryDiagnosticsProvider } from "#src/memoryDiagnostics.js";

const logger = createServiceLogger("drora-agent-service");
...
interface PendingPermissionRequest {
  client: DroraProtocolClient;
  protocolRequestId: DroraProtocolRequestId;
}
...
interface PendingSessionRuntimePreferencesRequest extends PendingPermissionRequest {
  request: DroraAgentSessionRuntimePreferencesRequest;
...
function isClosedStdioTransportError(error: unknown): boolean {
  return error instanceof Error && error.message === "Drora agent stdio transport is closed";
}
...
function buildWorkspaceRef(params: DroraAgentWorkspaceTarget): DroraWorkspaceRef {
  return {
...
function savedWorkflowTargetHasWorkspace(
  params: DroraAgentSavedWorkflowTarget,
): params is DroraAgentWorkspaceTarget & { scope?: DroraSavedWorkflowScope } {
  return typeof (params as Partial<DroraAgentWorkspaceTarget>).workspacePath === "string";
}

// 只在 `scope` 有定义时下推到 RPC params：不给 scope 的项目档保持与今天逐字一致的线上形状。
function savedWorkflowScopeParam(params: DroraAgentSavedWorkflowTarget): {
  scope?: DroraSavedWorkflowScope;
} {
  return params.scope === undefined ? {} : { scope: params.scope };
}

function ensurePluginManagementWorkspacePath(): string {
  const workspacePath = join(getDataBaseDir(), ".drora", PLUGIN_MANAGEMENT_WORKSPACE_DIR_NAME);
...
// NOTE: this counts ONLY the per-session MCP servers passed through the Drora Protocol
// session/create params (the app→protocol channel). It is deliberately independent of the
// CLI/bootstrap MCP servers configured in ~/.drora/cli/config.json (mcp.servers), which the agent
// runtime connects separately and reports via the `mcp.server.connected`/toolCount events. So a
// createSession log line with mcpServerCount:0 is EXPECTED when drora-cua is a CLI-config MCP server
...
// real kimi-k2.6 turns call mcp__drora-cua__* tools (get_app_state/type/open_application, status
...
function isProtocolRequestTimeout(error: unknown, method: string): boolean {
  if (error instanceof DroraProtocolRequestTimeoutError) {
    return error.method === method;
  }
  return error instanceof Error && error.message === `Drora Protocol request timed out: ${method}`;
}
...
function buildSessionCreateParams(
  params: DroraAgentCreateSessionParams & {
...
function buildSessionResumeParams(
  params: DroraAgentResumeSessionParams & {
    offPeakToolEnabled?: boolean;
    dynamicWorkflowEnabled?: boolean;
  },
...
function buildSessionSendParams(
  params: DroraAgentSendPromptParams,
...
function buildSessionCompactParams(params: DroraAgentCompactParams) {
  return {
    sessionId: params.sessionId,
    inputId: params.inputId,
...
function formatModelSelectionForLog(ref: ModelSelection | undefined): string | null {
  ...
  return reasoningLevel ? `${base}${DRORA_MODEL_REASONING_SEPARATOR}${reasoningLevel}` : base;
}

function sessionEventKey(params: DroraAgentSessionTarget): string {
...
function permissionRequestKey(params: DroraAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function userInputRequestKey(params: DroraAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function providerRuntimeHeadersRequestKey(
  params: DroraAgentSessionTarget & { requestId: string },
): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}
...
interface DroraAgentProviderReadinessSnapshot {
...
): DroraAgentProviderReadinessSnapshot {
...
interface WaitingWorkspaceStartup {
  ...
  workspace: DroraAgentWorkspaceTarget;
}
...
function createRuntimeUnavailableError(params: DroraAgentWorkspaceTarget): Error & {
  code: typeof DRORA_AGENT_RUNTIME_UNAVAILABLE_CODE;
  workspaceKey: string;
} {
  const error = new Error("Drora Agent runtime is not running.") as Error & {
    code: typeof DRORA_AGENT_RUNTIME_UNAVAILABLE_CODE;
    workspaceKey: string;
  };
  error.code = DRORA_AGENT_RUNTIME_UNAVAILABLE_CODE;
  error.workspaceKey = resolveWorkspaceKey(params);
  return error;
}

interface CreateDroraAgentServiceOptions extends Omit<
  DroraAgentProcessManagerOptions,
  "idleTimeoutMs"
> {
  ...
  resolveSessionRuntimePreferences?: (
    scope: DroraSessionRuntimePreferencesScope,
  ) => Promise<DroraSessionRuntimePreferencesResult>;
  /** manual run 落库后由当前 host 直接派发；返回时 prompt 必须已被 session 接受。 */
  onAutomationManualRunRequested?: (params: {
    automation: DroraAutomation;
    run: DroraAutomationRun;
  }) => Promise<void>;
  /**
...
function toProtocolAutomation(automation: DroraAutomation) {
  return {
...
async function respondOffPeakInternalError(
  client: Pick<DroraProtocolClient, "respondError">,
  request: { id: DroraProtocolRequestId; method: string },
  workspace: DroraAgentWorkspaceTarget,
  error: unknown,
): Promise<void> {
...
export function createDroraAgentService(
  options?: CreateDroraAgentServiceOptions,
): IDroraAgentService & { disposeAllAndWait(): Promise<void> } {
  const processManager = new DroraAgentProcessManager(options);
  ...
  const pluginProcessManager = new DroraAgentProcessManager({
  ...
  const mcpStatusProcessManager = new DroraAgentProcessManager({
    commandResolver: options?.commandResolver,
    presentationSurface: options?.presentationSurface,
  ...
  const sessionEmitters = new Map<string, Emitter<DroraAgentServiceEvent>>();
  /**
  ...
  const sessionRuntimePreferencesRequestEmitter =
    new Emitter<DroraAgentSessionRuntimePreferencesRequest>();
  const processResourceSampleEmitter = new Emitter<AgentLaneResourceSample>();
  const toolExecResourceEmitter = new Emitter<DroraToolExecResource>();
  const mcpResourceSamplesEmitter = new Emitter<DroraMcpResourceSample[]>();
  const mcpTelemetryEmitter = new Emitter<DroraMcpTelemetryEvent>();
  const pluginOperationProgressEmitters = new Map<
    string,
    Emitter<DroraPluginOperationProgressNotification>
  >();
  ...
  const cuaPermissionObservationEmitter = new Emitter<DroraAgentCuaPermissionObservation>();
  ...
  const wiredClients = new WeakSet<DroraProtocolClient>();
  const clientDisposables = new WeakMap<DroraProtocolClient, IDisposable[]>();
  ...
  let latestAppRuntimePreferences: DroraAgentAppRuntimePreferences | undefined;
  ...
  const accountConfigSyncByClient = new WeakMap<DroraProtocolClient, Promise<void>>();
  // 此缓存只去重已交付的账号快照，不表示 Worker 的 Registry 已应用该版本。
  const accountConfigReceivedRevisionByClient = new WeakMap<DroraProtocolClient, string>();
  ...
  function invalidateWorkspaceClient(workspaceKey: string, client: DroraProtocolClient): void {
  ...
  async function respondAccountRequestAuthWithoutInteraction(params: {
    ...
    try {
      ...
      if (pendingProviderRuntimeHeaders.get(params.key) !== params.pending) return;
      logger.warn(undefined, "Drora provider runtime headers 应用失败", {
        modelId: params.pending.request.modelSelection.modelId,
        providerId: params.pending.request.providerId,
        requestId: params.pending.request.requestId,
        sessionId: params.pending.request.sessionId,
  ...
  function expireSessionRuntimePreferencesRequest(requestId: string): void {
    ...
    logger.warn(undefined, "运行时偏好请求等待 Host 响应超时", {
      event: "drora_agent.runtime_preferences.host_response_timeout",
      module: "services.drora_agent",
      requestId,
      scope: pending.request.scope,
      sessionId: pending.request.sessionId,
      timeoutMs: DRORA_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
    ...
    const current = previous
      ...
      .then(async () => {
        ...
        const result = await params.client.request(
          droraProtocolMethods.providerUpdateAccountConfig,
          {
        ...
        logger.info(undefined, "account provider config 已交付到 Drora agent", {
  ...
  function enqueueInteractionPreferenceSync(params: {
    client: DroraProtocolClient;
    preferences: DroraAgentAppRuntimePreferences;
    workspace: DroraAgentWorkspaceTarget;
  }): Promise<void> {
    ...
    const current = previous
      ...
      .then(async () => {
        await params.client.request(
          droraProtocolMethods.workspaceUpdateInteractionPreferences,
          {
        ...
        try {
          await params.client.request(
            droraProtocolMethods.workspaceUpdateModelIoPreferences,
            {
              workspace: buildWorkspaceRef(params.workspace),
              preferences: {
  ...
  async function handleProviderReadinessChanged(event: {
    reason: string;
    snapshot: DroraAgentProviderReadinessSnapshot;
  }): Promise<void> {
    if (event.snapshot.readiness.ready) {
      await Promise.allSettled(
        Array.from(waitingWorkspaceStartups.entries()).map(async ([workspaceKey, waiting]) => {
          ...
          logger.info(undefined, "provider/model 就绪后已启动等待中的 Drora agent", {
  ...
  function getSessionEmitter(params: DroraAgentSessionTarget) {
    const key = sessionEventKey(params);
    const existing = sessionEmitters.get(key);
    if (existing) {
      return existing;
    }
    const created = new Emitter<DroraAgentServiceEvent>();
  ...
  function getPluginOperationProgressEmitter(operationId: string) {
    ...
    let created: Emitter<DroraPluginOperationProgressNotification>;
    created = new Emitter({
  ...
  function getConversationFrameEmitter(workspace: DroraAgentWorkspaceTarget) {
  ...
  function getConversationTelemetryFactEmitter(workspace: DroraAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getSessionsIndexFrameEmitter(workspace: DroraAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getWorkspaceConfigFrameEmitter(workspace: DroraAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  ): DroraAgentV4ConnectionContext {
    return (
      readTrustedDroraAgentV4Connection(params) ?? {
  ...
  function resolveV4UnsubscribeRoute(
    params: DroraAgentConversationUnsubscribeParams | DroraAgentConversationResyncParams,
    topicPrefix: string,
  ): V4SubscriptionRoute | null {
    const expectedWorkspaceKey = resolveWorkspaceKey(params);
    const trusted = readTrustedDroraAgentV4UnsubscribeRoute(params);
    if (trusted) {
  ...
  async function unsubscribeV4Route(
    params: DroraAgentConversationUnsubscribeParams,
    topicPrefix: string,
  ): Promise<void> {
  ...
  async function resyncV4Route(params: DroraAgentConversationResyncParams, topicPrefix: string) {
    const route = resolveV4UnsubscribeRoute(params, topicPrefix);
  ...
  function handleStateUpdated(
    workspace: DroraAgentWorkspaceTarget,
    notification: DroraStateUpdatedNotification,
  ): void {
  ...
  function wireClient(
    ...
    const disposables = [
      client.onNotification((message) => {
        if (message.method === droraProtocolNotifications.providerRuntimeHeadersCancelled) {
          const parsed = droraProviderRuntimeHeadersCancelledSchema.safeParse(message.params);
          if (
            !parsed.success ||
        ...
        if (message.method === droraProtocolNotifications.processResourceSample) {
          const parsed = droraProcessResourceSampleSchema.safeParse(message.params);
          if (parsed.success) {
            processResourceSampleEmitter.fire({ ...parsed.data, lane });
          } else {
            logger.debug(undefined, "丢弃无效 Drora CLI 资源样本", {
        ...
        if (message.method === droraProtocolNotifications.toolExecResource) {
          const parsed = droraToolExecResourceSchema.safeParse(message.params);
          if (parsed.success) toolExecResourceEmitter.fire(parsed.data);
          return;
        }
        if (message.method === droraProtocolNotifications.mcpResourceSamples) {
          const parsed = droraMcpResourceSamplesSchema.safeParse(message.params);
          if (parsed.success) mcpResourceSamplesEmitter.fire(parsed.data);
          else logger.debug(undefined, "丢弃无效 MCP 资源样本");
          return;
        }

        if (message.method === droraProtocolNotifications.mcpTelemetry) {
          const parsed = droraMcpTelemetryEventSchema.safeParse(message.params);
          if (parsed.success) {
            mcpTelemetryEmitter.fire(parsed.data);
          } else {
            logger.debug(undefined, "丢弃无效 Drora CLI MCP 遥测事件", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                path: issue.path.join("."),
              })),
        ...
        if (message.method === droraProtocolNotifications.pluginOperationProgress) {
          const parsed = droraPluginOperationProgressNotificationSchema.safeParse(message.params);
          if (parsed.success) {
            pluginOperationProgressEmitters.get(parsed.data.operationId)?.fire(parsed.data);
          } else {
            logger.warn(undefined, "丢弃无效 Drora Protocol 插件操作进度", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
        ...
        if (message.method === droraProtocolMethods.computerUseOperationEvent) {
          const parsed = droraComputerUseOperationEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(undefined, "丢弃无效 Drora Protocol Computer Use operation event", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                message: issue.message,
                path: issue.path.join("."),
        ...
        if (message.method === "session/event") {
          const parsed = droraSessionEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(
              ...
              "丢弃无效 Drora Protocol session event",
              {
        ...
        if (message.method === "state.updated") {
          const parsed = droraStateUpdatedNotificationSchema.safeParse(message.params);
          if (parsed.success) {
      ...
      client.onRequest((request) => {
        if (request.method === droraProtocolMethods.sessionRequestRuntimePreferences) {
          ...
          const parsed = droraSessionRequestRuntimePreferencesParamsSchema.safeParse(
            request.params,
          );
          if (!parsed.success) {
            void client
          ...
          if (sessionRuntimePreferencesAuthority === "local") {
            void (async () => {
              let preferences: DroraSessionRuntimePreferencesResult;
              try {
                preferences = droraSessionRuntimePreferencesResultSchema.parse(
          ...
          const dynamicRequest: DroraAgentSessionRuntimePreferencesRequest = {
            ...parsed.data,
            requestId,
          };
          ...
          logger.info(undefined, "运行时偏好请求已转发给 Host", {
            event: "drora_agent.runtime_preferences.host_request_dispatched",
            module: "services.drora_agent",
            requestId,
        ...
        if (request.method === droraProtocolMethods.interactionRequestPermission) {
          const parsed = droraPermissionRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
        ...
        if (request.method === droraProtocolMethods.interactionRequestUserInput) {
          const parsed = droraUserInputRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === droraProtocolMethods.interactionRequestProviderRuntimeHeaders) {
          const parsed = droraProviderRuntimeHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
          ...
          logger.info(request.trace?.traceId, "收到 Drora provider runtime headers 请求", {
        ...
        if (request.method === droraProtocolMethods.interactionRequestOfficialMcpAuthHeaders) {
          const parsed = droraOfficialMcpAuthHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === droraProtocolMethods.interactionBrowserList) {
          const parsed = droraBrowserListParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === droraProtocolMethods.interactionBrowserExecute) {
          const parsed = droraBrowserExecuteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === droraProtocolMethods.automationCreate) {
          const parsed = droraAutomationCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === droraProtocolMethods.offPeakCreate) {
          const parsed = droraOffPeakCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === droraProtocolMethods.offPeakList) {
          const parsed = droraOffPeakListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === droraProtocolMethods.automationList) {
          const parsed = droraAutomationListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === droraProtocolMethods.automationCheckTaskBinding) {
          const parsed = droraAutomationCheckTaskBindingParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === droraProtocolMethods.automationUpdate) {
          const parsed = droraAutomationUpdateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === droraProtocolMethods.automationDelete) {
          const parsed = droraAutomationDeleteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        void client.respondError(request.id, {
          code: -32601,
          message: `Unsupported Drora Protocol request: ${request.method}`,
        });
      }),
      client.onClose(() => {
  ...
  function rememberSessionTrace(
    target: DroraAgentSessionTarget,
  ...
  function getSessionTraceId(target: DroraAgentSessionTarget): TraceId | undefined {
  ...
  function createProviderNotReadyError(params: {
    ...
    code: typeof DRORA_AGENT_PROVIDER_NOT_READY_CODE;
    data: {
      providerCount: number;
      reason: typeof DRORA_AGENT_PROVIDER_NOT_READY_REASON;
    ...
    error.code = DRORA_AGENT_PROVIDER_NOT_READY_CODE;
    error.data = {
      providerCount: params.snapshot?.providerCount ?? 0,
      reason: DRORA_AGENT_PROVIDER_NOT_READY_REASON,
  ...
  function isProviderNotReadyError(
    error: unknown,
  ): error is Error & { code: typeof DRORA_AGENT_PROVIDER_NOT_READY_CODE } {
    return (
      error instanceof Error &&
      (error as { code?: unknown }).code === DRORA_AGENT_PROVIDER_NOT_READY_CODE
    );
  }

  async function resolveStartupReadiness(): Promise<
    DroraAgentProviderReadinessSnapshot | undefined
  > {
  ...
  function isReusableActiveClientEntry(
    ...
    activeClientsByWorkspaceKey.delete(workspaceKey);
    interactionPreferenceSyncByWorkspaceKey.delete(workspaceKey);
    logger.warn(undefined, "复用的 Drora Protocol client 已 disposed，清理 stale entry", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return false;
  ...
  async function getOrStartReadOnlyClient(
    ...
    const interactionPreferencesReady = (async () => {
      let appliedSnapshot: DroraAgentAppRuntimePreferences | undefined;
    ...
    const offPeakToolPolicyReady = (async () => {
      ...
      try {
        await client.request(
          droraProtocolMethods.workspaceUpdateOffPeakToolPolicy,
    ...
    const dynamicWorkflowPolicyReady = (async () => {
      ...
      try {
        await client.request(
          droraProtocolMethods.workspaceUpdateDynamicWorkflowPolicy,
          { workspace: buildWorkspaceRef(params), enabled: true },
          droraWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
        );
      } catch (error) {
    ...
    logger.info(undefined, "为只读会话控制面启动 Drora agent", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return entry;
  ...
  async function getClient(params: DroraAgentWorkspaceTarget) {
    const workspaceKey = resolveWorkspaceKey(params);
    const active = activeClientsByWorkspaceKey.get(workspaceKey);
    ...
    if (!readinessSnapshot || !readiness?.ready) {
      ...
      if (waiting.lastLoggedRevision !== revision) {
        ...
        logger.info(
          undefined,
          active
            ? "provider/model 尚未就绪，Drora agent 保持只读"
            : "provider/model 尚未就绪，Drora agent 保持未启动",
          {
    ...
    waitingWorkspaceStartups.delete(workspaceKey);
    logger.info(undefined, "provider/model 就绪，允许 Drora agent 模型执行", {
  ...
  async function getPluginManagementClient(): Promise<DroraProtocolClient> {
  ...
  // homedir() 即用户家目录，全局根 `~/.drora/workflows/` 因此解析到真实目录。
  // 远程 runtime（SSH/WSL identity 或带 remoteSessionId）的 home 不是本机，绝不选它当载体。
  function isLocalActiveWorkspaceClient(workspace: DroraAgentWorkspaceTarget): boolean {
    return (
      !workspace.remoteSessionId &&
      !(workspace.workspaceIdentity && isRemoteWorkspaceIdentity(workspace.workspaceIdentity))
    );
  ...
  async function resolveSavedWorkflowCarrier(
    params: DroraAgentSavedWorkflowTarget,
  ): Promise<{ client: DroraProtocolClient; workspace: DroraWorkspaceRef }> {
  ...
  async function getMcpStatusClient(): Promise<DroraProtocolClient> {
    const workspace = { workspacePath: ensurePluginManagementWorkspacePath() };
  ...
  async function buildConversationCommandEnvelope(
    params: DroraAgentConversationCommandParams,
  ...
  return {
    ...
    async initialize(params: DroraAgentWorkspaceTarget): Promise<DroraAgentInitializeResult> {
      const workspaceKey = resolveWorkspaceKey(params);
      const startedAt = Date.now();
      logger.info(undefined, "开始初始化 Drora agent", {
        workspaceKey,
        workspacePath: params.workspacePath,
      });
      try {
        const client = await getClient(params);
        logger.info(undefined, "Drora agent 初始化完成", {
        ...
        return {
          available: true,
          workspaceKey,
          protocolName: DRORA_PROTOCOL_NAME,
          protocolVersion: DRORA_PROTOCOL_VERSION,
          transportKind: client.transportKind === "websocket" ? "websocket" : "stdio",
        };
      } catch (error) {
        ...
        logger[providerNotReady ? "info" : "warn"](
          undefined,
          providerNotReady ? "Drora agent 等待 provider/model 就绪" : "Drora agent 初始化失败",
          {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            workspaceKey,
        ...
        return {
          ...
          ...(providerNotReady ? { reasonCode: DRORA_AGENT_PROVIDER_NOT_READY_REASON } : {}),
        };
      }
    },

    async syncAppRuntimePreferences(preferences: DroraAgentAppRuntimePreferences): Promise<void> {
      const normalizedPreferences: DroraAgentAppRuntimePreferences = {
        ...preferences,
    ...
    async getWorkspaceRuntimeIdentity(params: DroraAgentWorkspaceTarget) {
    ...
    async createSession(params: DroraAgentCreateSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      logger.info(sessionTraceId, "开始请求 Drora Protocol session/create", {
      ...
      try {
        const snapshot = await client.request(
          droraProtocolMethods.sessionCreate,
        ...
        logger.info(sessionTraceId, "Drora Protocol session/create 完成", {
          durationMs: Date.now() - startedAt,
        ...
        if (compatFields.length === 0) {
          logger.warn(sessionTraceId, "Drora Protocol session/create 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            persistence: params.persistence,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId, "Drora Protocol session/create 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
        ...
        if (!compatFields.includes("thoughtLevel") || !params.thoughtLevel) {
          logger.info(sessionTraceId, "Drora Protocol session/create 兼容重试完成", {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
            snapshotTraceId: snapshot.session.traceId ?? null,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        const snapshotWithThoughtLevel = await client.request(
          droraProtocolMethods.sessionSetThoughtLevel,
          {
            sessionId: snapshot.session.sessionId,
            thoughtLevel: params.thoughtLevel,
        ...
        logger.info(
          sessionTraceId,
          "Drora Protocol session/create 兼容重试后设置 thoughtLevel 完成",
          {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
    ...
    async resumeSession(params: DroraAgentResumeSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      const dynamicWorkflowEnabled = await resolveDynamicWorkflowGate();
      logger.info(cachedTraceId, "开始请求 Drora Protocol session/resume", {
        mcpServerCount: getMcpServerCount(params),
        mcpServerNames: getMcpServerNames(params),
      ...
      try {
        const snapshot = await client.request(
          droraProtocolMethods.sessionResume,
        ...
        logger.info(sessionTraceId, "Drora Protocol session/resume 完成", {
          durationMs: Date.now() - startedAt,
          messageCount: snapshot.messages.length,
          modelCurrent: formatModelSelectionForLog(snapshot.settings.model.current),
          mcpServerCount: getMcpServerCount(params),
        ...
        if (compatFields.length === 0) {
          logger.warn(cachedTraceId, "Drora Protocol session/resume 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(cachedTraceId, "Drora Protocol session/resume 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        const sessionTraceId = rememberSessionTrace(params, snapshot) ?? cachedTraceId;
        logger.info(sessionTraceId, "Drora Protocol session/resume 兼容重试完成", {
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          snapshotTraceId: snapshot.session.traceId ?? null,
          workspaceKey: resolveWorkspaceKey(params),
    ...
    async listSessions(params: DroraAgentListSessionsParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const result = await client.request(
        droraProtocolMethods.sessionList,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async listSessionSubagents(params: DroraAgentListSessionSubagentsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        droraProtocolMethods.sessionSubagents,
        {
          sessionId: params.sessionId,
    ...
    async getAppUsageStats(params: DroraAgentAppUsageParams) {
    ...
    async getTaskTokenUsage(params: DroraAgentTaskTokenUsageParams) {
      const client = await getReadOnlyClient(params);
    ...
    async readSession(params: DroraAgentReadSessionParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      ...
      const snapshot = await client.request(
        droraProtocolMethods.sessionRead,
        {
          sessionId: params.sessionId,
    ...
    async readSessionMessages(params: DroraAgentReadSessionMessagesParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        droraProtocolMethods.sessionMessages,
        {
          sessionId: params.sessionId,
    ...
    async readSessionDebug(params) {
      ...
      return client.request(
        droraProtocolMethods.sessionDebug,
        { sessionId: params.sessionId },
        sessionDebugSnapshotSchema,
      );
    },

    async readSessionEvents(params: DroraAgentReadSessionEventsParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        droraProtocolMethods.sessionEvents,
        {
          sessionId: params.sessionId,
          afterSeq: params.afterSeq,
          limit: params.limit,
    ...
    async readWorkspacePresentation(params: DroraAgentReadWorkspacePresentationParams) {
      const startedAt = Date.now();
      logger.info(undefined, "开始请求 Drora Protocol workspace/readPresentation", {
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      });
      try {
        let presentation: DroraWorkspacePresentation | undefined;
        for (let attempt = 0; attempt < 2; attempt += 1) {
          ...
          try {
            ...
            presentation = await client.request(
              droraProtocolMethods.workspaceReadPresentation,
              { workspace: buildWorkspaceRef(params) },
              droraWorkspacePresentationSchema,
            );
            break;
        ...
        if (!presentation) {
          throw new Error("Drora Protocol workspace/readPresentation did not return a result");
        }
        logger.info(undefined, "Drora Protocol workspace/readPresentation 完成", {
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(undefined, "Drora Protocol workspace/readPresentation 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
    ...
    async grantWorkspaceHookTrust(params: DroraAgentGrantWorkspaceHookTrustParams) {
    ...
    async listMcpServerStatuses(params: DroraAgentListMcpServerStatusesParams) {
      ...
      try {
        ...
        if (params.mode === "status" && unrecognizedKeys.includes("mode")) {
          ...
          throw new DroraAgentMcpStatusModeUnsupportedError();
        }
        if (
        ...
        if (!isProtocolRequestTimeout(error, droraProtocolMethods.mcpList)) {
          throw error;
        }
    ...
    async listPlugins(params: DroraAgentPluginViewParams) {
      const requestPluginsList = async () => {
        ...
        return client.request(
          droraProtocolMethods.pluginsList,
          {
            workspace: buildWorkspaceRef(params),
      ...
      try {
        ...
        if (!isProtocolRequestTimeout(error, droraProtocolMethods.pluginsList)) {
          throw error;
        }
    ...
    async getPluginReferenceCatalog(params: DroraAgentPluginReferenceCatalogParams) {
    ...
    async getSkillReferenceCatalog(params: DroraAgentSkillReferenceCatalogParams) {
      // 与 Plugin 引用一样，Session 快照只存在于 workspace agent 进程；独立管理进程
      // 没有 resident Session，不能作为对话 authority。
      const client = await getReadOnlyClient(params);
      return client.request(
        droraProtocolMethods.skillsReferenceCatalog,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.sessionId ? { sessionId: params.sessionId } : {}),
        },
    ...
    // `scope` 只在有定义时下推。
    async listSavedWorkflows(params: DroraAgentListSavedWorkflowsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        droraProtocolMethods.workflowsList,
        { workspace, ...savedWorkflowScopeParam(params) },
        droraWorkflowsListResultSchema,
      );
    },

    async getSavedWorkflow(params: DroraAgentGetSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        droraProtocolMethods.workflowsGet,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        droraWorkflowsGetResultSchema,
      );
    },

    async updateSavedWorkflowMeta(params: DroraAgentUpdateSavedWorkflowMetaParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        droraProtocolMethods.workflowsUpdateMeta,
        { workspace, name: params.name, meta: params.meta, ...savedWorkflowScopeParam(params) },
        droraWorkflowsUpdateMetaResultSchema,
      );
    },

    async deleteSavedWorkflow(params: DroraAgentDeleteSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        droraProtocolMethods.workflowsDelete,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        droraWorkflowsDeleteResultSchema,
      );
    },

    async listSavedWorkflowRuns(params: DroraAgentListSavedWorkflowRunsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        droraProtocolMethods.workflowsRuns,
        {
          workspace,
    ...
    async moveSavedWorkflow(params: DroraAgentMoveSavedWorkflowParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        droraProtocolMethods.workflowsMove,
        { workspace: buildWorkspaceRef(params), name: params.name },
        droraWorkflowsMoveResultSchema,
      );
    },

    async resolveSuggestedPluginReference(params: DroraAgentResolveSuggestedPluginReferenceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsResolveSuggestedReference,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async collectLocalRuntimeChildProcesses(signal?: AbortSignal) {
      ...
      return Promise.all(
        managed.map(async (runtime) => {
          let children: DroraProcessChildProcess[] = [];
          try {
            const result = await runtime.client.request(
              droraProtocolMethods.processChildProcesses,
              {},
              droraProcessChildProcessesResultSchema,
    ...
    async getPluginsOverview(params: DroraAgentPluginViewParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsOverview,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.configScope ? { configScope: params.configScope } : {}),
        },
    ...
    async addPluginMarketplace(params: DroraAgentAddPluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsMarketplaceAdd,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async removePluginMarketplace(params: DroraAgentRemovePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsMarketplaceRemove,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePluginMarketplace(params: DroraAgentUpdatePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsMarketplaceUpdate,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async installPlugin(params: DroraAgentInstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsInstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async cancelPluginOperation(params: DroraAgentCancelPluginOperationParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsCancelOperation,
        { operationId: params.operationId },
        droraPluginsCancelOperationResultSchema,
    ...
    async uninstallPlugin(params: DroraAgentUninstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsUninstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePlugin(params: DroraAgentUpdatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsUpdate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginId ? { pluginId: params.pluginId } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async restoreBuiltinPlugin(params: DroraAgentRestoreBuiltinPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsRestoreBuiltin,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async configurePlugin(params: DroraAgentConfigurePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsConfigure,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async resetPluginConfig(params: DroraAgentResetPluginConfigParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsResetConfig,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
          ...(params.scope ? { scope: params.scope } : {}),
    ...
    async validatePlugin(params: DroraAgentValidatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsValidate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginName ? { pluginName: params.pluginName } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async describePlugin(params: DroraAgentDescribePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsDescribe,
        {
          workspace: buildWorkspaceRef(params),
          marketplace: params.marketplace,
          pluginName: params.pluginName,
    ...
    async setPluginEnabled(params: DroraAgentSetPluginEnabledParams) {
      const client = await getPluginManagementClient();
      return client.request(
        droraProtocolMethods.pluginsSetEnabled,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async listAutomations(params: DroraAgentWorkspaceTarget) {
    ...
    async createAutomation(params: DroraAgentCreateAutomationParams) {
      return automationService.create({
        ...
        mode: params.mode as DroraTaskMode | undefined,
        workspacePath: params.workspacePath,
        workspaceIdentity: params.workspaceIdentity,
    ...
    async updateAutomation(params: DroraAgentUpdateAutomationParams) {
      return automationService.update(
        params.automationId,
        {
          ...
          prompt: params.prompt,
          modelSelection: params.modelSelection,
          mode: params.mode === null ? null : (params.mode as DroraTaskMode | undefined),
    ...
    async deleteAutomation(params: DroraAgentAutomationIdParams) {
    ...
    async setAutomationEnabled(params: DroraAgentSetAutomationEnabledParams) {
    ...
    async restartAutomation(params: DroraAgentAutomationIdParams) {
    ...
    async runAutomationNow(params: DroraAgentAutomationIdParams) {
    ...
    async listAutomationRuns(params: DroraAgentAutomationIdParams) {
    ...
    async deleteAutomationRun(params: DroraAgentDeleteAutomationRunParams) {
    ...
    async generateWorkspaceText(params: DroraAgentGenerateWorkspaceTextParams) {
      const client = await getClient(params);
      // Worker 自己读取 Drora Built-in / Personal Config；Host 只在执行前确保账号状态形成的
      ...
      const cancel = () => {
        ...
        void client
          .request(
            droraProtocolMethods.workspaceCancelGenerateText,
            { operationId },
            droraWorkspaceCancelGenerateTextResultSchema,
            { timeoutMs: 5_000 },
          )
      ...
      try {
        return await client.request(
          droraProtocolMethods.workspaceGenerateText,
          {
            workspace: buildWorkspaceRef(params),
    ...
    async testModelConnectivity(params: DroraAgentTestModelConnectivityParams) {
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      return client.request(
        droraProtocolMethods.providerTestModelConnectivity,
        {
          workspace: buildWorkspaceRef(params),
          selection: params.selection,
        },
    ...
    async sendPrompt(params: DroraAgentSendPromptParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      ...
      const protocolParams: DroraAgentSendPromptParams = {
        ...params,
        ...(browserAmbientContext ? { browserAmbientContext } : {}),
      };
      logger.info(logTraceId, "Drora Agent session/send 开始", {
      ...
      try {
        const result = await client.request(
          droraProtocolMethods.sessionSend,
          buildSessionSendParams(protocolParams),
          droraSessionSendResultSchema,
        );
        logger.info(logTraceId, "Drora Agent session/send ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          queryId: params.queryId ?? null,
          sessionId: params.sessionId,
        ...
        if (compatFields.length > 0) {
          logger.warn(logTraceId, "Drora Agent session/send 命中新旧协议兼容重试", {
            compatFields,
            durationMs: Date.now() - startedAt,
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(logTraceId, "Drora Agent session/send 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          queryId: params.queryId ?? null,
    ...
    async compactSession(params: DroraAgentCompactParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const sessionTraceId = getSessionTraceId(params);
      logger.info(sessionTraceId ?? params.inputId, "Drora Protocol session/compact 开始", {
        inputId: params.inputId,
        sessionId: params.sessionId,
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      ...
      try {
        const result = await client.request(
          droraProtocolMethods.sessionCompact,
        ...
        logger.info(sessionTraceId ?? params.inputId, "Drora Protocol session/compact ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId ?? params.inputId, "Drora Protocol session/compact 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          sessionId: params.sessionId,
    ...
    async goalSession(params: DroraAgentGoalParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(params.inputId, "开始请求 Drora Protocol session/goal", {
      ...
      try {
        const result = await client.request(
          droraProtocolMethods.sessionGoal,
          {
            sessionId: params.sessionId,
            inputId: params.inputId,
            action: params.action,
        ...
        logger.info(params.inputId, "Drora Protocol session/goal 完成", {
          action: params.action,
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(params.inputId, "Drora Protocol session/goal 失败", {
          action: params.action,
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          sessionId: params.sessionId,
    ...
    async closeSession(
      params: DroraAgentSessionTarget & {
        expectedPersistence?: "deferred" | "immediate";
      },
    ): Promise<boolean> {
      const client = await getClient(params);
      const result = await client.request(
        droraProtocolMethods.sessionClose,
        {
          sessionId: params.sessionId,
    ...
    async setModel(params: DroraAgentSetModelParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(undefined, "开始请求 Drora Protocol session/setModel", {
      ...
      try {
        const snapshot = await client.request(
          droraProtocolMethods.sessionSetModel,
          {
            sessionId: params.sessionId,
            model: params.model,
            expectedRevision: params.expectedRevision,
        ...
        logger.info(undefined, "Drora Protocol session/setModel 完成", {
          durationMs: Date.now() - startedAt,
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
        ...
        logger.warn(undefined, "Drora Protocol session/setModel 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
    ...
    async setThoughtLevel(params: DroraAgentSetThoughtLevelParams) {
      const client = await getClient(params);
      const snapshot = await client.request(
        droraProtocolMethods.sessionSetThoughtLevel,
        {
    ...
    async setMode(params: DroraAgentSetModeParams) {
      const client = await getClient(params);
      return client.request(
        droraProtocolMethods.sessionSetMode,
        {
          sessionId: params.sessionId,
          mode: params.mode,
          expectedRevision: params.expectedRevision,
    ...
    async respondSessionRuntimePreferences(
      ...
      if (!pending) {
        logger.warn(undefined, "运行时偏好响应找不到 pending 请求", {
          event: "drora_agent.runtime_preferences.response_without_pending",
          module: "services.drora_agent",
          requestId: params.requestId,
        });
        throw new Error(`Drora session runtime preferences request not found: ${params.requestId}`);
      }
      const responseContext = {
        event: "drora_agent.runtime_preferences.host_response_received",
        module: "services.drora_agent",
        requestId: params.requestId,
        scope: pending.request.scope,
        sessionId: pending.request.sessionId,
    ...
    onDynamicSessionEvent(params: DroraAgentSessionSubscribeParams) {
      ...
      return (listener) => {
        ...
        const pendingLiveEvents: DroraAgentServiceEvent[] = [];
        ...
        const deliverToListener = (event: DroraAgentServiceEvent): void => {
          if (cancelled) {
            return;
          }
        ...
        const establishSubscription = async (attempt: number): Promise<void> => {
          ...
          try {
            ...
            const result = await client.request(
              droraProtocolMethods.sessionSubscribe,
              {
                sessionId: params.sessionId,
                deliveryKind: params.deliveryKind,
                afterSeq: params.afterSeq,
            ...
            if (attempt >= SESSION_SUBSCRIBE_MAX_ATTEMPTS - 1) {
              ...
              console.warn(
                formatLogPrefix("drora-agent", process.pid),
    ...
    async setConnectionFlowStateV4(params: DroraAgentConnectionFlowParams) {
      const trusted = readTrustedDroraAgentV4Connection(params);
    ...
    async subscribeConversationV4(params: DroraAgentConversationSubscribeParams) {
      ...
      // Account Config 顺序屏障，不提升模型执行权限。Drora Built-in / Personal 仍由 Worker 维护。
    ...
    async unsubscribeConversationV4(params: DroraAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "conversation/");
    },

    async resyncConversationV4(params: DroraAgentConversationResyncParams) {
      return resyncV4Route(params, "conversation/");
    },

    async sendConversationCommandV4(params: DroraAgentConversationCommandParams) {
      const client = await getClient(params);
      ...
      const commandClientMode =
        readTrustedDroraAgentV4Connection(params)?.clientMode ??
        params.clientMode ??
        "desktop-continuous";
      if (params.envelope.type === "createSession") {
        // V4 草稿预热直接走 command 转发；新会话创建前只需等待 Account Config，
        // Drora Built-in / Personal 已由 Worker 进程 Registry 自己装配。
        await ensureAccountProviderConfigSynced({
          client,
    ...
    async queryConversationCommandsV4(params: DroraAgentCommandsQueryParams) {
      if (!readTrustedDroraAgentV4Connection(params)) {
    ...
    async attachmentBeginV4(params: DroraAgentAttachmentBeginParams) {
      const trusted = readTrustedDroraAgentV4Connection(params);
    ...
    async attachmentChunkV4(params: DroraAgentAttachmentChunkParams) {
      const trusted = readTrustedDroraAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentCommitV4(params: DroraAgentAttachmentTerminalParams) {
      const trusted = readTrustedDroraAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentAbortV4(params: DroraAgentAttachmentTerminalParams) {
      const trusted = readTrustedDroraAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentReadV4(params: DroraAgentAttachmentReadParams) {
      if (!readTrustedDroraAgentV4Connection(params)) {
    ...
    async conversationAttachmentReadV4(params: DroraAgentConversationAttachmentReadParams) {
      if (!readTrustedDroraAgentV4Connection(params)) {
        throw new DroraAttachmentFaultError(
          DRORA_ATTACHMENT_FAULT_CODES.shareReadConnectionUntrusted,
        );
      }
    ...
    async conversationAttachmentStatV4(params: DroraAgentConversationAttachmentStatParams) {
      if (!readTrustedDroraAgentV4Connection(params)) {
        throw new DroraAttachmentFaultError(
          DRORA_ATTACHMENT_FAULT_CODES.shareStatConnectionUntrusted,
        );
      }
    ...
    async attachmentPreviewSourceV4(params: DroraAgentAttachmentPreviewSourceParams) {
      const trusted = readTrustedDroraAgentV4Connection(params);
    ...
    async conversationRowsRangeV4(params: DroraAgentConversationRowsRangeParams) {
      const trusted = readTrustedDroraAgentV4Connection(params);
    ...
    async conversationPlansV4(params: DroraAgentConversationPlansParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunEventsV4(params: DroraAgentConversationWorkflowRunEventsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunsV4(params: DroraAgentConversationWorkflowRunsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async backgroundBashOutputV4(params: DroraAgentBackgroundBashOutputParams) {
      if (!readTrustedDroraAgentV4Connection(params))
    ...
    async conversationFileChangesV4(params: DroraAgentConversationFileChangesParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationFileRewindPreviewV4(params: DroraAgentConversationFileRewindPreviewParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    onDynamicConversationFrame(params: DroraAgentWorkspaceTarget) {
      return getConversationFrameEmitter(params).event;
    },

    onDynamicLocalTtftFacts(params: DroraAgentWorkspaceTarget) {
    ...
    onDynamicConversationTelemetryFact(params: DroraAgentWorkspaceTarget) {
    ...
    async subscribeSessionsIndexV4(params: DroraAgentSessionsIndexSubscribeParams) {
    ...
    async unsubscribeSessionsIndexV4(params: DroraAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "sessions-index/");
    },

    async resyncSessionsIndexV4(params: DroraAgentConversationResyncParams) {
      return resyncV4Route(params, "sessions-index/");
    },

    onDynamicSessionsIndexFrame(params: DroraAgentWorkspaceTarget) {
    ...
    async subscribeWorkspaceConfigV4(params: DroraAgentWorkspaceConfigSubscribeParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const connection = resolveV4Connection(params, v4ConnectionIdFor(params.subscriberScope));
    ...
    async unsubscribeWorkspaceConfigV4(params: DroraAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "workspace-config/");
    },

    async resyncWorkspaceConfigV4(params: DroraAgentConversationResyncParams) {
      return resyncV4Route(params, "workspace-config/");
    },

    onDynamicWorkspaceConfigFrame(params: DroraAgentWorkspaceTarget) {
    ...
    onAgentRuntimeLifecycle(listener: (event: DroraAgentRuntimeLifecycleEvent) => void) {
