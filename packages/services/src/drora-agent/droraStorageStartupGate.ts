...
export class DroraStorageStartupGate {
  private current?: DroraStorageStartupState;
  private terminalError?: Error;
  private pending?: Promise<void>;
  private resolve?: () => void;
  private reject?: (error: Error) => void;
  private timer?: ReturnType<typeof setTimeout>;
  private readonly changed = new Emitter<DroraStorageStartupState>();
  ...
  get snapshot(): DroraStorageStartupState | undefined {
    return this.current;
  }

  accept(input: unknown): boolean {
    const parsed = droraStorageStartupStateSchema.safeParse(input);
