import type { Hook, DroraWorkspaceHookTrustGrantResult } from "@drora/shared";
import type { WorkspaceHookBundleSnapshotData } from "@drora/shared/workspace-hook-discovery";
