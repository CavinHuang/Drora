import { BIGMODEL_PROVIDER_ID, buildBigModelApiUrl } from "@drora/shared";
...
export function createBigModelProviderRuntimeConfig(
  ...
  return {
    ...
    tokenUrl:
      ...
      buildDroraApiUrlFromEnv(env, "/api/v1/oauth/token"),
    ...
    // 当前 BigModel callback 只消费 drora OAuth token 路由，显式 appSecret 仅保留给
