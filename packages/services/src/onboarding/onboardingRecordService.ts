...
import { onboardingRecordFileSchema } from "@drora/shared";
import { appSettingsOccupationEnum } from "@drora/shared";
import type {
...
function getRecordFile(): string {
  // 记录是设备级数据，必须跟随 dataBaseDir（用户自定义数据目录时落在其 .drora/v2 下，
