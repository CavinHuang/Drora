...
const APP_CA_CERT_FILE = "drora-network-ca.pem";
const APP_CA_KEY_FILE = "drora-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "Drora Network CA" },
    { name: "organizationName", value: "Drora" },
  ];
