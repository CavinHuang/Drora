...
import type { DroraAgentMcpServer } from "@drora/shared";
...
function isFilesystemServer(
  server: DroraAgentMcpServer,
): server is Extract<DroraAgentMcpServer, { command: string }> {
  return (
    "command" in server &&
...
export function appendWorkspaceToFilesystemMcpServers(
  mcpServers: DroraAgentMcpServer[] | undefined,
  workspacePath: string,
): DroraAgentMcpServer[] | undefined {
