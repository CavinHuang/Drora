...
import { z } from "zod";
import type { OffPeakTakeNumberAvailability } from "@drora/shared";
import type { ServiceLogger } from "../logger/serviceLogger.js";
import {
  withRequestIdHeader,
  REQUEST_ID_HEADER_NAME,
} from "#src/providers/api/requestIdHeaders.js";
import { buildDroraSourceHeaders } from "#src/providers/sourceHeaders.js";
import {
...
interface OffPeakServerClientDeps {
  /** API origin（真实服务端或 mock 网关，DRORA_OFFPEAK_MOCK 切换在装配层）；mock 网关懒启动故允许异步。 */
