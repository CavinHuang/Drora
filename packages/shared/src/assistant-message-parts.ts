export type DroraAssistantMessagePart =
  | {
      type: "content";
      content: string;
    }
...
export function appendAssistantMessagePart(
  parts: readonly DroraAssistantMessagePart[] | undefined,
  nextPart: DroraAssistantMessagePart,
) {
...
export function getLatestAssistantContentPart(parts: readonly DroraAssistantMessagePart[]) {
...
export function getLatestAssistantContentText(parts: readonly DroraAssistantMessagePart[]) {
