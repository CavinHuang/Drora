...
export type CommandAgentSource = "droraAgent";
...
export type DroraCommand = UserCommand | PluginCommand;

export function isUserCommand(command: DroraCommand): command is UserCommand {
  return command.source === "user";
}

export function isPluginCommand(command: DroraCommand): command is PluginCommand {
