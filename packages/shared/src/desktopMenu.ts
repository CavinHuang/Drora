...
export const desktopMenuMessageIds = {
  ...
  helpToggleDroraStdioTap: "titleBar.menu.help.toggleDroraStdioTap",
  helpDroraEndpoint: "titleBar.menu.help.droraEndpoint",
  helpDroraEndpointProduction: "titleBar.menu.help.droraEndpoint.production",
  helpDroraEndpointTest: "titleBar.menu.help.droraEndpoint.test",
  helpDroraEndpointCustom: "titleBar.menu.help.droraEndpoint.custom",
  helpDroraEndpointReset: "titleBar.menu.help.droraEndpoint.reset",
...
export const desktopMenuMessages: Record<Locale, DesktopMenuLocaleMessages> = {
  "zh-CN": {
    ...
    "titleBar.menu.help.droraEndpoint": "Drora Endpoint",
    "titleBar.menu.help.droraEndpoint.production": "Production（默认）",
    "titleBar.menu.help.droraEndpoint.test": "Test",
    "titleBar.menu.help.droraEndpoint.custom": "自定义...",
    "titleBar.menu.help.droraEndpoint.reset": "恢复默认",
  ...
  "en-US": {
    ...
    "titleBar.menu.help.droraEndpoint": "Drora Endpoint",
    "titleBar.menu.help.droraEndpoint.production": "Production (default)",
    "titleBar.menu.help.droraEndpoint.test": "Test",
    "titleBar.menu.help.droraEndpoint.custom": "Custom...",
    "titleBar.menu.help.droraEndpoint.reset": "Reset to default",
