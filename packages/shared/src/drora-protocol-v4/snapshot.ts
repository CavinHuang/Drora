...
import {
  ...
  droraSessionContextCacheUsageSchema,
...
export const sessionUsageStateSchema = z.object({
  contextWindow: z
    .object({
      ...
      cache: droraSessionContextCacheUsageSchema.optional(),
      breakdown: droraContextUsageBreakdownSchema.optional(),
    })
    .nullable(),
  cumulative: z.object({
...
const permissionOptionSchema = z.object({
  ...
  response: droraPermissionResponseSchema.optional(),
});
