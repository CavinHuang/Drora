export type BuiltinDroraSlashCommandHelpEntry = {
...
export const BUILTIN_DRORA_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinDroraSlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    {
      details: ["Deletes Z.ai OAuth credentials from the shared Drora credential store."],
      name: "logout",
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.drora/AGENTS.md.",
      ],
      name: "init",
