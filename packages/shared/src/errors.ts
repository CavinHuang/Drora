...
export const DRORA_FILE_LOCK_TIMEOUT_ERROR_CODE = "DRORA_FILE_LOCK_TIMEOUT" as const;
...
export function isDroraFileLockTimeoutError(error: unknown): boolean {
  return normalizeUnknownError(error).code === DRORA_FILE_LOCK_TIMEOUT_ERROR_CODE;
}
