export const DRORA_AGENT_PROVIDER_NOT_READY_CODE = "DRORA_AGENT_PROVIDER_NOT_READY" as const;
export const DRORA_AGENT_PROVIDER_NOT_READY_REASON = "provider_not_ready" as const;
