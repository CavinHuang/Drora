...
import type { DroraElicitationQuestion, DroraElicitationRequest } from "@drora/shared";
import type { InteractionAutoResolution } from "@drora/shared/drora-protocol-v4";
...
interface ElicitationDialogProps {
  request: DroraElicitationRequest;
...
interface NormalizedElicitationQuestion extends DroraElicitationQuestion {
  key: string;
}
...
function isPlanApprovalElicitationRequest(request: DroraElicitationRequest): boolean {
