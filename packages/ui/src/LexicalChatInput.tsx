...
function E2ELexicalInputBridgePlugin({ inputTestId }: { inputTestId?: string }) {
  ...
  useEffect(() => {
    ...
    const detachBridge = (input: HTMLElement | null) => {
      if (
        input &&
        (input as { __droraLexicalInputE2E?: typeof bridge }).__droraLexicalInputE2E === bridge
      ) {
        delete (input as { __droraLexicalInputE2E?: typeof bridge }).__droraLexicalInputE2E;
      }
    ...
    const attachBridge = (input: HTMLElement | null) => {
      ...
      Object.defineProperty(input, "__droraLexicalInputE2E", {
        configurable: true,
        value: bridge,
      });
