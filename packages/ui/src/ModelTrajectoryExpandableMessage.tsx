import type { DroraModelTrajectoryMessage } from "@drora/services";
...
type IntlShape = ReturnType<typeof useDroraIntl>["intl"];
...
function compactTextPreview(message: DroraModelTrajectoryMessage): string {
...
function firstLinePreview(message: DroraModelTrajectoryMessage): string {
...
function messageClipboardText(message: DroraModelTrajectoryMessage): string {
