...
export type IntlShape = ReturnType<typeof useDroraIntl>["intl"];
...
export function CallCard({
  ...
  record: DroraModelTrajectoryRecord;
  index: number;
  inputMessages: DroraModelTrajectoryMessage[];
...
function SourceTitle({ record, intl }: { record: DroraModelTrajectoryRecord; intl: IntlShape }) {
  const callSource: NonNullable<DroraModelTrajectoryRecord["callSource"]> = record.callSource ?? {
    kind: "main",
  };
...
function sourceLabelId(callSource: NonNullable<DroraModelTrajectoryRecord["callSource"]>): string {
...
function MessageBlock({
  ...
  message: DroraModelTrajectoryMessage;
...
function ResponseBlock({
  ...
  response: NonNullable<DroraModelTrajectoryRecord["response"]>;
  callStartedAt: string;
  callDurationMs?: number;
