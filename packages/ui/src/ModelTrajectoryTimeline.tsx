...
import type { DroraModelTrajectoryRecord } from "@drora/services";
import {
...
export function resolveTrajectoryTimelineItems(records: DroraModelTrajectoryRecord[]) {
...
export function resolveTrajectoryInputMessages({
  ...
  inputMessages: DroraModelTrajectoryRecord["request"]["messages"];
...
function shouldUseConversationDelta(record: DroraModelTrajectoryRecord): boolean {
  const kind = record.callSource?.kind;
  return kind === undefined || kind === "main" || kind === "subagent";
}

function computeDeltaMessages(
  messages: DroraModelTrajectoryRecord["request"]["messages"],
  previousMessageCount: number,
  index: number,
): DroraModelTrajectoryRecord["request"]["messages"] {
