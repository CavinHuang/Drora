...
import { createUuid, type RemoteTarget, type RemoteWorkspaceSessionEntry } from "@drora/shared";
import {
                ...
                {currentStep === "directory" ? (
                  <div data-testid={TID_SSH_SUCCESS} className="h-full">
                    <RemoteConnectionDirectoryStep
                      ...
                      remoteDroraAgentService={directoryBrowserServices?.droraAgentService ?? null}
