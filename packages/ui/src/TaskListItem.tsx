...
import { isCronTask, isOffPeakTask, type DroraTaskMeta } from "@drora/shared";
import { TID_TASK_ARCHIVE, TID_TASK_ITEM, testId } from "@drora/shared";
...
function getTaskAutomationIdentity(task: DroraTaskMeta): string | undefined {
  return task.cronAutomationId ?? (task as DroraTaskMeta & { automationId?: string }).automationId;
}

function areTaskListItemTaskFieldsEqual(left: DroraTaskMeta, right: DroraTaskMeta) {
  if (left === right) {
    return true;
  }
