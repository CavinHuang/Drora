...
import { TID_CRON_CREATE_CARD, TID_CRON_CREATE_OPEN } from "@drora/shared";
import type { DroraAutomationScheduleRule } from "@drora/shared";
...
function isScheduleRule(value: unknown): value is DroraAutomationScheduleRule {
...
function readCronCreateAutomationOutputSummary(value: unknown): CronCreateAutomationSummary | null {
  ...
  const scheduleRule = isScheduleRule(automation.scheduleRule)
    ? (automation.scheduleRule as DroraAutomationScheduleRule)
    : undefined;
