...
import type { ApplicationIconRequest } from "@drora/shared";
import { useDroraIntl } from "@/i18n/IntlProvider.js";
import { isDroraCuaToolName } from "@/lib/cuaPermissionAction.js";
...
function readCuaToolName(value: string | null | undefined): string | null {
  ...
  //   main namesp: mcp__plugin_drora_cua_computer_use__<action>
...
export function isCuaToolCall(
  ...
  return collectToolNames(toolCall).some(isDroraCuaToolName);
}
...
type CuaIntl = ReturnType<typeof useDroraIntl>["intl"];
