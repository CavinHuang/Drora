 ...
 *
 * 一行的读法与模型面
 * （apps/drora-cli/packages/core/src/tool/handlers/get-workflow-run-format-roster.ts）同一句话：
...
import type { ToolCallGetWorkflowRunDisplay } from "@drora/shared/drora-protocol-v4";
...
type FormatMessage = ReturnType<typeof useDroraIntl>["intl"]["formatMessage"];
