...
import type { Locale, RemoteTarget, UserInfo, DroraTaskMeta } from "@drora/shared";
import { BUILTIN_MODEL_PROVIDER_IDS } from "@drora/shared";
import {
...
const EMPTY_WORKSPACE_TASK_ITEMS: DroraTaskMeta[] = [];
...
export const WorkspaceSidebar = memo(function WorkspaceSidebarComponent({
  ...
  const bumpTaskListVersion = useDroraSessionStore((state) => state.bumpTaskListVersion);
