...
import { TID_APP_HEADER } from "@drora/shared";
...
import type { ComposerMentionPrefill } from "@/store/droraSessionStoreTypes.js";
...
const WORKSPACE_SIDEBAR_WIDTH_STORAGE_KEY = "drora:workspace-shell:sidebar-width-px";
...
export const WorkspaceShellLayout = memo(function WorkspaceShellLayoutComponent({
  ...
  usePaneSessionPersistence({
    ...
    draftFocusVersion: workspaceShellDroraState.draftFocusVersion,
  ...
  return (
    <DesktopWindowFrame
      title={`Drora / ${getPathLeaf(workspaceAbsPath)}`}
      showHeader
      isDesktop={isDesktop}
                    ...
                    {shouldRenderWorkspaceHeader ? (
                      ...
                      >
                        <WorkspaceHeader
                          ...
                          workspaceHeaderState={workspaceShellDroraState}
                          gitSummary={gitState.summary}
