...
import type { IFeedbackService, IServiceAccessor } from "@drora/services";
...
import type { WorkspaceDroraUIState } from "@/store/droraSessionStore.js";
...
export interface WorkspaceShellDroraState {
  activeTaskId: WorkspaceDroraUIState["activeTaskId"];
  draftFocusVersion: WorkspaceDroraUIState["draftFocusVersion"];
  modelSwitchPending: WorkspaceDroraUIState["modelSwitchPending"];
  modelSwitchStage: WorkspaceDroraUIState["modelSwitchStage"];
  selectedProvider: WorkspaceDroraUIState["selectedProvider"];
  optimisticTaskListByTaskId: WorkspaceDroraUIState["optimisticTaskListByTaskId"];
  workspaceInit: WorkspaceDroraUIState["workspaceInit"];
  taskStatus: DroraTaskRuntimeStatus;
...
export type CreateTaskRequest = DroraProvider | CreateTaskOptions;
...
export type WorkspaceMainView = "chat" | "automations" | "plugin-store" | "vault";
...
export interface WorkspaceShellLayoutProps extends Omit<AppProps, "baseFeedbackService"> {
  ...
  workspaceTabs: Array<{
    ...
    remoteTarget?: import("@drora/shared").RemoteTarget;
    workspaceIdentity?: string;
  ...
  handleStartDraftInWorkspace: (
    targetWorkspacePath: string,
    targetWorkspaceIdentity?: string,
    targetWorkspacePurpose?: import("@drora/shared").WorkspacePurpose,
    createSource?: SessionCreateSource,
  ) => void;
