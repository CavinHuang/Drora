...
type ContextUsageBreakdownSource = DroraContextUsageBreakdownItem["source"];
...
function buildContextUsageBreakdownSegments(
  breakdown: readonly DroraContextUsageBreakdownItem[] | undefined,
...
export function getRenderableTaskUsage<T extends { used: number; size: number }>(
  ...
  // Drora Protocol 迁移后会单独补齐真实 contextUsed/contextWindow。
...
export function getContextCompressionCommand(_provider: DroraProvider): string {
  return "/compact";
}
