...
import { unpackWorkspaceFileEntries } from "@drora/shared/workspaceFileEntriesCodec";
...
import type { WorkspaceFileEntry, DroraTaskChangeSummary, DroraTaskMeta } from "@drora/shared";
import {
  Command,
  CommandDialog,
  CommandEmpty,
...
type TaskSearchResultItem = DroraTaskMeta & {
  searchSnippet?: string;
  searchSnippets?: string[];
};
type TaskChangedFileSummary = DroraTaskChangeSummary["files"][number];
...
function getTaskTitle(task: DroraTaskMeta, untitledLabel: string): string {
