...
import type { BackgroundBashOutput, BackgroundBashOutputResult } from "@drora/shared";
import { useDroraAgentService } from "@/hooks/useDroraAgentService.js";
...
export function useBackgroundBashOutput(target: BackgroundBashOutputTarget, visible: boolean) {
  ...
  const service = useDroraAgentService(workspacePath, remoteSessionId, workspaceIdentity);
