...
import type { IUsageStatsService } from "@drora/services";
import type {
  CodingPlanResetScopeRequest,
  CodingPlanResetStatusSnapshot,
  CodingPlanResetType,
  DroraAccountAccess,
  DroraProviderAccountAccess,
} from "@drora/shared";
...
export function useCodingPlanQuotaResetUi({
  ...
  accountAccess?: DroraProviderAccountAccess | DroraAccountAccess | null;
  enabled?: boolean;
