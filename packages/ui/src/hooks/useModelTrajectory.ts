 ...
 *
 * 路径解析与文件读取都收口在 droraTaskService.getModelTrajectory（host 侧），
...
export function useModelTrajectory(
  ...
  }, [droraTaskService, taskId, workspaceIdentity, workspacePath, reloadToken]);
