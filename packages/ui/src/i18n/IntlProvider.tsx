...
import type { Locale, LocalePreference } from "@drora/shared";
import { DEFAULT_LOCALE } from "@drora/shared";
import type { BroadcastMessage, IBroadcastService, ISettingService } from "@drora/services";
import {
...
const LOCALE_PREFERENCE_KEY = "drora-locale-preference";
 ...
 */
export function DroraIntlProvider({
  children,
  settingService,
  broadcastService,
  initialLocale,
...
/** 获取 intl 上下文 */
export function useDroraIntl(): IntlContextValue {
  const ctx = useContext(IntlContext);
  if (!ctx) {
    throw new Error("useDroraIntl 必须在 DroraIntlProvider 内使用");
  }
  return ctx;
}
