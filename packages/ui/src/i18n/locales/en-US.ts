...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like Drora to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let Drora remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting Drora",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen Drora.",
  ...
  "startup.global.starting_services": "Starting Drora",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "Drora will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another Drora or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen Drora. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen Drora to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen Drora.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a Drora restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into Drora",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to Drora and try again",
  ...
  "bots.title": "Bots",
  "bots.description": "Connect external chats and webhooks to Drora bots.",
  "bots.listTitle": "Bots",
  "bots.addBot": "New bot",
  ...
  "bots.setup.guide.weixin.create.2":
    "Drora saves the bot_token returned by iLink automatically; after scanning, send any message to the bot in Weixin to activate the chat.",
  "bots.setup.guide.weixin.create.3":
    "Drora uses a built-in iLink client: `/ilink/bot/getupdates` for long polling and `/ilink/bot/sendmessage` for replies.",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook mode does not require a native bot in the third-party product; your integration only needs to POST messages to Drora.",
  ...
  "bots.setup.guide.webhook.bind.1":
    "POST a private-message callback to Drora's `/api/bots/webhook` endpoint.",
  ...
  "bots.setup.guide.webhook.bind.3":
    "If the bot uses a secret, also send `x-drora-bot-secret`; then return here after the bind succeeds.",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere":
    "Telegram long polling is handled by another Drora window.",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to Drora",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to Drora",
  "login.description": "Connect your account to start using Drora",
  ...
  "logout.confirm.title": "Disconnect and restart Drora?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only Drora Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About Drora",
  ...
  "titleBar.menu.help.toggleDroraStdioTap": "Capture agent stdio traffic",
  ...
  "vault.unconfigured.description":
    "Pick an Obsidian Vault or use the Drora managed Vault to browse and edit Markdown notes here.",
  "vault.useManaged": "Use Drora managed Vault",
  "vault.candidates.title": "Detected Vaults",
  "vault.candidates.empty": "No Obsidian Vault detected",
  "vault.candidate.obsidian": "Obsidian",
  "vault.candidate.managed": "Managed",
  ...
  "vault.rename": "Rename",
  "vault.delete": "Delete",
  "vault.delete.title": "Delete note",
  "vault.delete.description": "Delete \"{name}\"? This cannot be undone.",
  "vault.delete.confirm": "Delete",
  "vault.create": "Create",
  "vault.cancel": "Cancel",
  "vault.namePlaceholder": "Name",
  "vault.save": "Save",
  "vault.overwrite": "Overwrite Vault version",
  "vault.conflict":
    "The file was modified externally in the Vault, so the save was rejected. Overwrite it or copy your draft first.",
  "vault.unsaved.title": "Unsaved changes",
  "vault.unsaved.description": "Switching notes will discard unsaved changes. Continue?",
  "vault.unsaved.discard": "Discard changes",
  "vault.loading": "Loading…",
  "vault.emptyTree": "Vault is empty",
  "vault.noFileSelected": "Select a note on the left to start editing",
  "vault.paste.unsupported": "Clipboard does not contain a supported image (PNG/JPEG/GIF/WebP)",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart Drora to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the Drora CDN and have download, extract, and checksum tools.",
  ...
  "webRemoteControl.qr.title": "Scan with your phone",
  "webRemoteControl.qr.description":
    "While your phone is on the same network, scan the code to view tasks, send prompts and handle permission requests remotely.",
  "webRemoteControl.qr.generate": "Generate pairing QR code",
  "webRemoteControl.qr.generating": "Generating…",
  "webRemoteControl.qr.hint": "The QR code is valid for 5 minutes, on this network only.",
  "webRemoteControl.qr.copyLink": "Copy link",
  "webRemoteControl.qr.copied": "Copied",
  "webRemoteControl.qr.connected": "Phone connected. You can now control tasks from your phone.",
  "webRemoteControl.qr.stop": "Stop pairing service",
  "webRemoteControl.qr.generateFailed": "Failed to start pairing service",
  "webRemoteControl.title": "Mobile remote control",
  "webRemoteControl.description": "Control Drora workspaces through chat bots.",
  ...
  "remote.kind.server.wizardDescription": "A running Drora service",
  ...
  "server.description": "Connect to a running Drora server.",
  ...
  "server.tokenPlaceholder": "Enter the connection token",
  ...
  "server.workspacePathDescription":
    "Leave it empty to choose a directory on the server after connecting.",
  "server.validation.urlRequired": "Server URL is required",
  "server.validation.invalidUrl": "Server URL format is invalid.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "Drora checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the Drora terminal font.",
  ...
  "settings.droraInteractionBehavior": "Interaction behavior",
  "settings.droraInteractionBehaviorDescription":
    "While Drora is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  "settings.droraInteractionBehavior.option.queue": "Queue",
  "settings.droraInteractionBehavior.option.guide": "Guide",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the Drora installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching Drora task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by Drora",
  ...
  "resourceManager.storage.diskUsage": "Drora uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the Drora desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Drora could not verify its Windows secure import component. Reinstall or update Drora before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, Drora will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by Drora Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "Drora provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This Drora Agent cannot refresh OAuth status. Upgrade or restart Drora, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to Drora to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into Drora",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to Drora 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by Drora automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in Drora.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. Drora uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in Drora after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "Drora MCP",
  ...
  "sidebar.usage.plan.mcp": "Drora MCP",
  "sidebar.usage.plan.droraMcp": "Drora MCP",
  "sidebar.usage.plan.droraMcpDescription": "Daily aggregate quota for Drora built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into Drora. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. Drora follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into Drora",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by Drora Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend Drora with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into Drora and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. Drora follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into Drora",
  ...
  "settings.commands.description":
    "Manage Drora Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.droraAgent": "Drora Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into Drora. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. Drora follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into Drora",
  ...
  "settings.workspaceFileSearch.description":
    "Edit .droraignore rules (gitignore syntax) that scope workspace file search. Takes effect on the next search after saving.",
  "settings.workspaceFileSearch.templateHint":
    ".droraignore does not exist yet: the content below is the initial preview (.gitignore copy + default exclusions); it is written to the workspace only after saving.",
  ...
  "settings.workspaceFileSearch.revealHint": "Save first; .droraignore lives at the workspace root",
  ...
  "settingsSync.action.finish": "Start using Drora",
  "settingsSync.agent.drora": "Drora Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current Drora settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to Drora",
  ...
  "onboarding.welcome.title": "Welcome to Drora",
  "onboarding.welcome.start": "Start Drora",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while Drora imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "Drora will copy {source} to {target}.\nIf the target file already exists, the Drora default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask Drora anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask Drora anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, Drora will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want Drora to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart Drora app and retry, or ask Drora to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with Drora in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for Drora: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with Drora in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current Drora Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'Drora MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No Drora MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  // Drora Agent
  "drora.unavailable": "AI agent not available",
  "drora.initFailed": "Failed to start AI agent",
  "drora.error.TASK_OWNED_BY_OTHER_HOST": "This task is already running in another connected view.",
  "drora.error.STALE_TASK_OWNER_COMMAND": "This action belongs to an older run and was ignored.",
  "drora.error.NO_ACTIVE_TASK_OWNER": "No active task owner is available for this action.",
  "drora.error.OWNER_COMMAND_FAILED": "The task owner could not complete this action.",
  "drora.error.MEDIA_BUDGET_CURRENT_ATTACHMENT_TOO_LARGE":
    "Current attachments are too large for one request. Remove or compress attachments and try again.",
  "drora.error.MEDIA_BUDGET_CURRENT_IMAGE_TOO_LARGE":
    "Current image attachments are too large. Remove or compress images and try again.",
  "drora.error.MEDIA_BUDGET_CURRENT_VIDEO_TOO_LARGE":
    "Current video attachments are too large. Remove or compress videos and try again.",
  "drora.error.DRORA_RUNTIME_MODEL_UNAVAILABLE":
    "The current model is no longer available. Select an available model from the current model list to continue.",
  "drora.error.DRORA_BIGMODEL_TEAM_PLAN_MEMBER_REQUIRED":
    "The current model is unavailable. Check whether the current account has been added to the project member list.",
  "drora.error.providerBusiness.1006": "Your login session has expired. Please sign in again.",
  "drora.error.providerBusiness.1005":
    "Today's free plan quota has been used up. Upgrade to continue now, or wait for the quota to reset.",
  "drora.error.providerBusiness.3006":
    "The current model is not included in this plan. Switch to an allowed model and try again.",
  "drora.error.providerBusiness.3002":
    "You're sending requests too quickly. Please try again later.",
  "drora.error.providerBusiness.3001":
    "The request parameters are invalid. Check the input and try again.",
  "drora.error.providerBusiness.3007":
    "The request was rejected by the gateway security check. Please try again later or contact support.",
  "drora.error.providerBusiness.3008":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "drora.error.providerBusiness.3009":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "drora.error.providerBusiness.3010":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "drora.error.providerBusiness.3102":
    "This run exceeded the maximum single-run time. Create a new off-peak task to continue.",
  "drora.error.modelSuspiciousEmpty":
    "The model returned no content (often caused by an expired token or plan issues). Please send again.",
  "drora.error.providerBusiness.2007":
    "The upstream service is temporarily unavailable. Please try again later.",
  "drora.error.providerBusiness.429":
    "You're sending requests too quickly. Please try again later.",
  ...
  "resourceManager.appUsage": "Drora",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Drora Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while Drora is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task Drora can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Drora Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "Drora Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart Drora",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart Drora to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified Drora plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "Drora will verify the Computer Use tools against the exact session when your first session starts.",
