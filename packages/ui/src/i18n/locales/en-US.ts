...
const enUS: Record<string, string> = {
  ...
  "webRemoteControl.qr.description": "While your phone is on the same network, scan the code to view tasks, send prompts and handle permission requests remotely.",
