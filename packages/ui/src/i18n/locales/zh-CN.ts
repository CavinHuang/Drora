...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 Drora 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 Drora 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 Drora 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 Drora",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 Drora。",
  ...
  "startup.global.starting_services": "正在启动 Drora",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 Drora。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 Drora 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 Drora",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 Drora 后重试",
  ...
  "bots.title": "机器人",
  "bots.description": "把外部聊天工具和 Webhook 接入 Drora 机器人。",
  "bots.listTitle": "机器人",
  "bots.addBot": "新建机器人",
  ...
  "bots.setup.guide.weixin.create.2":
    "Drora 会直接保存 iLink 返回的 bot_token；扫码后请在微信里向 Bot 发送任意消息完成会话激活。",
  "bots.setup.guide.weixin.create.3":
    "Drora 内置 iLink 客户端，通过 `/ilink/bot/getupdates` 长轮询收消息，通过 `/ilink/bot/sendmessage` 回复。",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook 模式不需要先在第三方平台创建原生机器人；你的系统只需要能向 Drora 回调接口发消息。",
  ...
  "bots.setup.guide.webhook.bind.1": "向 Drora 的 `/api/bots/webhook` 发送一条私聊消息回调。",
  ...
  "bots.setup.guide.webhook.bind.3":
    "如果配置了 secret，请同时在请求头里带上 `x-drora-bot-secret`；绑定成功后再回到这里完成设置。",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere": "Telegram 长轮询由另一个 Drora 窗口处理。",
  ...
  "login.title": "欢迎来到 Drora",
  "login.description": "连接账号，开始使用 Drora",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 Drora？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 Drora Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 Drora",
  ...
  "titleBar.menu.help.toggleDroraStdioTap": "抓取 Agent stdio 通信",
  ...
  "vault.unavailable": "当前环境未提供 Vault 服务。",
  "vault.unconfigured.title": "尚未配置 Vault",
  "vault.unconfigured.description": "选择一个 Obsidian Vault 或使用 Drora 托管 Vault，即可在这里浏览与编辑 Markdown 笔记。",
  "vault.useManaged": "使用 Drora 托管 Vault",
  "vault.candidates.title": "检测到的 Vault",
  "vault.candidates.empty": "未检测到 Obsidian Vault",
  "vault.candidate.obsidian": "Obsidian",
  "vault.candidate.managed": "托管",
  "vault.switchVault": "切换 Vault",
  "vault.refresh": "刷新",
  "vault.newNote": "新建笔记",
  "vault.newFolder": "新建文件夹",
  "vault.rename": "重命名",
  "vault.delete": "删除",
  "vault.delete.title": "删除笔记",
  "vault.delete.description": "确定要删除「{name}」吗？此操作不可撤销。",
  "vault.delete.confirm": "删除",
  "vault.create": "创建",
  "vault.cancel": "取消",
  "vault.namePlaceholder": "名称",
  "vault.save": "保存",
  "vault.overwrite": "覆盖 Vault 版本",
  "vault.conflict": "文件已在 Vault 中被外部修改，保存被拒绝。可选择覆盖或先复制草稿。",
  "vault.unsaved.title": "有未保存的修改",
  "vault.unsaved.description": "切换笔记将丢失当前未保存的修改，确定要继续吗？",
  "vault.unsaved.discard": "放弃修改",
  "vault.loading": "加载中…",
  "vault.emptyTree": "Vault 为空",
  "vault.noFileSelected": "选择左侧笔记开始编辑",
  "vault.paste.unsupported": "剪贴板内容不是受支持的图片格式（PNG/JPEG/GIF/WebP）",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 Drora 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 Drora CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "webRemoteControl.qr.title": "手机扫码连接",
  "webRemoteControl.qr.description":
    "手机与电脑处于同一网络时，用相机扫码即可远程查看任务、发送输入和处理权限请求。",
  "webRemoteControl.qr.generate": "生成配对二维码",
  "webRemoteControl.qr.generating": "正在生成…",
  "webRemoteControl.qr.hint": "二维码 5 分钟内有效，仅限当前网络使用。",
  "webRemoteControl.qr.copyLink": "复制链接",
  "webRemoteControl.qr.copied": "已复制",
  "webRemoteControl.qr.connected": "手机已连接，可在手机上操作任务。",
  "webRemoteControl.qr.stop": "停止配对服务",
  "webRemoteControl.qr.generateFailed": "启动配对服务失败",
  "webRemoteControl.title": "移动端远程控制",
  "webRemoteControl.description": "通过聊天机器人控制 Drora 工作区。",
  ...
  "remote.kind.server.wizardDescription": "已运行的 Drora 服务",
  "remote.connect": "连接",
  ...
  "server.description": "连接已经运行的 Drora server。",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 Drora 终端的字体覆盖。",
  ...
  "settings.droraInteractionBehavior": "交互行为",
  "settings.droraInteractionBehaviorDescription":
    "在 Drora 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  "settings.droraInteractionBehavior.option.queue": "队列",
  "settings.droraInteractionBehavior.option.guide": "引导",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 Drora 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 Drora 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "Drora 总占用",
  ...
  "resourceManager.storage.diskUsage": "Drora 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 Drora 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Drora 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 Drora。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。Drora 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.description": "管理 Drora Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 Drora 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 Drora Agent 不支持 OAuth 状态刷新。请升级或重启 Drora，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 Drora。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 Drora",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 Drora 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 Drora 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 Drora 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。Drora 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。Drora 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 Drora 即可继续编码。",
  ...
  "sidebar.usage.plan.droraMcpDescription": "Drora 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 Drora。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。Drora 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 Drora",
  ...
  "settings.subagents.description": "管理 Drora Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 Drora 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 Drora，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。Drora 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 Drora",
  ...
  "settings.commands.description":
    "管理 Drora Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 Drora。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。Drora 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 Drora",
  ...
  "settings.workspaceFileSearch.description":
    "编辑 .droraignore 忽略规则（语法与 .gitignore 一致），控制工作区文件搜索的范围。保存后下次搜索生效。",
  "settings.workspaceFileSearch.templateHint":
    ".droraignore 尚未创建：下方为初始内容预览（.gitignore 拷贝 + 默认排除规则），保存后才会写入工作区。",
  ...
  "settings.workspaceFileSearch.revealHint": "保存后即可在工作区根目录找到 .droraignore",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 Drora 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 Drora",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 Drora",
  "onboarding.welcome.start": "开始使用 Drora",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 Drora 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，Drora 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 Drora 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 Drora 提问…",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 Drora 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 Drora 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 Drora 修订后另存一版。",
  ...
  "chat.quota.mcp.quotaExhausted": "Drora MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 Drora MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  // Drora Agent
  "drora.unavailable": "AI 代理不可用",
  "drora.initFailed": "启动 AI 代理失败",
  "drora.error.TASK_OWNED_BY_OTHER_HOST": "该任务正在另一个已连接视图中运行。",
  "drora.error.STALE_TASK_OWNER_COMMAND": "该操作属于旧的运行轮次，已忽略。",
  "drora.error.NO_ACTIVE_TASK_OWNER": "当前没有可处理该操作的任务所有者。",
  "drora.error.OWNER_COMMAND_FAILED": "任务所有者未能完成该操作。",
  ...
  "drora.error.providerBusiness.1006": "登录状态已失效，请重新登录后再试。",
  "drora.error.providerBusiness.1005":
    "今日免费计划额度已用完。请升级账户、切换模型，或等待额度恢复。",
  "drora.error.providerBusiness.3006": "当前模型不在可用范围内，请切换到允许的模型后重试。",
  "drora.error.providerBusiness.3002": "请求过于频繁，请稍后重试。",
  "drora.error.providerBusiness.3001": "请求参数错误，请检查输入后重试。",
  "drora.error.providerBusiness.3007": "请求被网关安全校验拒绝，请稍后重试或联系支持。",
  "drora.error.providerBusiness.3008": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "drora.error.providerBusiness.3009": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "drora.error.providerBusiness.3010": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "drora.error.providerBusiness.3102": "已超过单次最长运行时间，请创建新的闲时任务继续。",
  "drora.error.modelSuspiciousEmpty": "模型未返回任何内容。",
  "drora.error.providerBusiness.2007": "上游服务暂时不可用，请稍后重试。",
  "drora.error.providerBusiness.429": "请求过于频繁，请稍后重试。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Drora 报错信息",
  ...
  "offPeak.keepAwakeBanner": "Drora 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 Drora 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Drora 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "Drora 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 Drora",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 Drora 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 Drora 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，Drora 会针对该会话精确验证电脑控制工具。",
