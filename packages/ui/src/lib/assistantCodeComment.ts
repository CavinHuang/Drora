  ...
  if (options.streaming) {
    ...
    if (unclosedStart !== null) {
      ...
      const prefixStart = findAssistantDirectivePrefixStart(
        content,
        [CODE_COMMENT_DIRECTIVE_NAME, "drora-file-citation"],
        protectedRanges,
        {
          minimumSingleColonPrefixLength: ":drora".length,
          singleColonDirectiveNames: ["drora-file-citation"],
          tripleColonDirectiveNames: ["drora-file-citation"],
        },
      );
      if (prefixStart !== null) {
