export const CODE_COMMENT_ADD_TO_CHAT_EVENT = "drora:code-comment-add-to-chat";
export const CODE_COMMENT_REMOVE_FROM_CHAT_EVENT = "drora:code-comment-remove-from-chat";
