...
function hasOwnTaskMetaField<T extends keyof DroraTaskMeta>(task: DroraTaskMeta, key: T) {
...
function resolveMergedTaskTitle(preferredTask: DroraTaskMeta, fallbackTask: DroraTaskMeta): string {
...
export function mergeTaskMetaCandidates(
  ...candidates: Array<DroraTaskMeta | null | undefined>
): DroraTaskMeta | undefined {
  let merged: DroraTaskMeta | undefined;
