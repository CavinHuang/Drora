...
const SETTINGS_SECTION_INTENT_KEY = "drora-settings-section-intent",
  SETTINGS_USAGE_TAB_INTENT_KEY = "drora-settings-usage-tab-intent",
  SETTINGS_PLUGIN_TAB_INTENT_KEY = "drora-settings-plugin-tab-intent",
  SETTINGS_PLUGIN_ORIGIN_INTENT_KEY = "drora-settings-plugin-origin-intent",
  SETTINGS_PLUGIN_SCOPE_KEY_INTENT_KEY = "drora-settings-plugin-scope-key-intent";
const SETTINGS_MODEL_PROVIDER_ID_INTENT_KEY = "drora-settings-model-provider-id-intent";
const SETTINGS_SECTION_INTENT_EVENT = "drora:settings-section-intent",
  SETTINGS_LAST_SECTION_STORAGE_KEY = "drora-settings-last-section";
