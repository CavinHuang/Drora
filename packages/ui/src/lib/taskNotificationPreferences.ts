const TASK_NOTIFICATION_ENABLED_STORAGE_KEY = "drora-notification-enabled";
const TASK_NOTIFICATION_SOUND_ENABLED_STORAGE_KEY = "drora-notification-sound-enabled";
