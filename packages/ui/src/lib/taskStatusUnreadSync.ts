...
import type { DroraTaskMeta, DroraWorkspaceTaskListChanged } from "@drora/shared";
...
import { getTaskUnreadIndicator, useDroraSessionStore } from "@/store/droraSessionStore.js";
import { bumpTaskListMembershipVersion } from "@/v4/taskListMembershipVersion.js";
import { logger } from "@/logger.js";

type TaskUnreadService = Pick<IDroraTaskService, "setTaskUnread">;
...
function buildStatusUnreadKey(event: DroraWorkspaceTaskListChanged, taskId: string): string {
...
function shouldMarkStatusEventTaskUnread(params: {
  ...
  event: DroraWorkspaceTaskListChanged;
}): boolean {
