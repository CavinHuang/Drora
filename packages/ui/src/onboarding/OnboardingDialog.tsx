...
export function OnboardingDialog(props: {
  ...
  const onboardingDialogRequested = useDroraStore((state) => state.onboardingDialogRequested);
  const clearOnboardingDialogRequest = useDroraStore((state) => state.clearOnboardingDialogRequest);
      ...
      const confirmed = await confirmDialog({
        ...
        description: intl.formatMessage(
          { id: "onboarding.agentsFile.confirmDescription" },
          {
            ...
            target: agentsFileMigration.status?.targetPath ?? "~/.drora/AGENTS.md",
          },
        ),
