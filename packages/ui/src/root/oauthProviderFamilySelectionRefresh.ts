...
import type { AccountProviderState } from "@drora/provider";
import type {
  OAuthProviderId,
...
async function refreshAccountProviderAccesses(params: {
  ...
  accesses: ReadonlyMap<string, DroraProviderAccountAccess | DroraAccountAccess>;
  ...
  try {
    ...
    const accesses = new Map(
      params.providerIds.flatMap((providerId) => {
        ...
        const query: DroraProviderAccountAccess | DroraAccountAccess =
