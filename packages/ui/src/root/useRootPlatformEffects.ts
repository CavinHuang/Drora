...
export function useRootPlatformEffects({
  ...
  initialWorkspacePurpose?: import("@drora/shared").WorkspacePurpose;
  ...
  isDesktop?: boolean;
  locale: ReturnType<typeof import("@/i18n/IntlProvider.js").useDroraIntl>["locale"];
  tabs: WindowTabState[];
  ...
  intl: ReturnType<typeof import("@/i18n/IntlProvider.js").useDroraIntl>["intl"];
  ...
  useEffect(() => {
    ...
    const disposeNotificationClick = platform.onTaskNotificationClick((taskId: string) => {
      ...
      const workspaces = useDroraSessionStore.getState().workspaces;
  ...
  useEffect(() => {
    ...
    void baseServices.conversationShareService
      ...
      .then((result) => {
        ...
        const sessionStore = useDroraSessionStore.getState();
  ...
  useEffect(() => {
    ...
    syncActiveSession();
    return useDroraSessionStore.subscribe(syncActiveSession);
