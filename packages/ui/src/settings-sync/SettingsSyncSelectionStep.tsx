...
import type { SettingsSyncCategory, SettingsSyncDiscoveryResult } from "@drora/shared";
...
function formatAgentName(agent: string, intl: ReturnType<typeof useDroraIntl>["intl"]): string {
  switch (agent) {
    case "drora":
      return intl.formatMessage({ id: "settingsSync.agent.drora" });
    case "claudeCode":
