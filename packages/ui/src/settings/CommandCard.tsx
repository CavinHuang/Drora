...
import type { UserCommand, DroraCommand } from "@drora/shared";
import { isPluginCommand, isUserCommand } from "@drora/shared";
...
export function isEditableUserCommand(command: DroraCommand): command is UserCommand {
  return isUserCommand(command) && command.location.source === "drora";
}

interface CommandCardProps {
  command: DroraCommand;
  onEdit?: (command: DroraCommand) => void;
  onToggle?: (command: DroraCommand, enabled: boolean) => void;
  isOperating?: boolean;
