...
import type { CommandConfig, UserCommand, DroraCommand } from "@drora/shared";
...
export function CommandsSection({
  ...
  const handleToggle = useCallback(
    async (command: DroraCommand, enabled: boolean) => {
  ...
  const renderCommandList = (items: DroraCommand[]) => (
    <SettingsResourceList
      items={items}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <CommandForm
            ...
            agentSource={editingCommand?.agentSource ?? DRORA_COMMAND_AGENT_SOURCE}
            scopeKey={formScopeKey}
