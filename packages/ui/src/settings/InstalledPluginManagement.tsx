...
import type { DroraPluginDiagnostic, DroraPluginInfo } from "@drora/shared";
 ...
 */
export function PluginWarningList({ warnings }: { warnings: DroraPluginDiagnostic[] }) {
  return (
...
export function PluginHookDetails({
  ...
  hooks: NonNullable<DroraPluginInfo["hookDetails"]>;
}) {
...
function formatHookCommand(hook: NonNullable<DroraPluginInfo["hookDetails"]>[number]): string {
