...
import type { McpSource, DroraMcpServer } from "@drora/shared";
...
export function McpServerForm({
  ...
  onSave: (form: FormState, prevServer?: DroraMcpServer) => void;
  onCancel: () => void;
  onDelete?: (server: DroraMcpServer) => void;
}) {
  const { intl } = useDroraIntl();
