...
function McpServerItem({
  ...
  server: DroraMcpServer;
  onEdit: (server: DroraMcpServer) => void;
  onToggle: (id: string, enabled: boolean) => void;
  onOpenAuthorization?: (server: DroraMcpServer) => void;
  ...
  const canEdit = !server.location || server.location.source === "drora";
