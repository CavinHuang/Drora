...
import type {
  ...
  DroraImportedSessionSkippedItem,
} from "@drora/shared";
...
function ImportIssuesList({
  ...
  title: string;
  items: DroraImportedSessionSkippedItem[];
}) {
...
export function MigrationCandidatesCard({
  ...
  candidates: DroraImportableSessionCandidate[];
  selectedSessionIds: string[];
  selectedCount: number;
  importError: string | null;
  lastImportResult: DroraImportSessionsResult | null;
  isImporting: boolean;
