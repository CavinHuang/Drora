...
interface OffPeakEditViewProps {
  ...
  onDelete?: (task: DroraOffPeakTask) => void;
  onDeleteHistory?: (task: DroraOffPeakTask) => void;
  onPause?: (task: DroraOffPeakTask) => void;
  onContinue?: (task: DroraOffPeakTask) => void;
...
export function OffPeakEditView({
  ...
  const thoughtLevelOption = useMemo<DroraConfigOption | null>(
    () =>
    ...
    >
      ...
      {tab === "history" ? (
        <OffPeakHistoryTab
          ...
          {...(onOpenSession
            ? {
                onOpenSession: (task: DroraOffPeakTask) =>
                  task.sessionId
                    ? onOpenSession({
