import type { DroraPluginComponentKind } from "@drora/shared";
...
const COMPONENT_BADGE_STYLES: Record<DroraPluginComponentKind, string> = {
...
const COMPONENT_LABEL_IDS: Record<DroraPluginComponentKind, string> = {
