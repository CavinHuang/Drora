...
import { TID_PLUGIN_STORE_BROWSE } from "@drora/shared";
...
function PluginList({
  ...
  const savePluginOptions = async (plugin: DroraPluginInfo) => {
  ...
  const renderPluginRows = (items: DroraPluginInfo[]) => (
  ...
  return (
    <section className="space-y-6" aria-labelledby="plugin-installed-title">
      ...
      <RemoteSyncDialogs
        ...
        remoteDroraAgentService={targetServiceResolution.services.droraAgentService}
