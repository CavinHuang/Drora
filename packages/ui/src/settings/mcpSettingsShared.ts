import type { McpServerConfig, DroraMcpServer } from "@drora/shared";

export const MCP_SECTIONS = ["droraagentmcp"] as const;
...
export function serverToForm(server: DroraMcpServer): FormState {
...
// 与 shared 层 convertToDroraAgentMcpServer 的 isMcpProtocolVersion 守卫保持同一语义：
