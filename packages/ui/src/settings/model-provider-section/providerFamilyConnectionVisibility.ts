...
export function resolveCodingPlanEntitlementState({
  ...
  accountAvailability?: import("@drora/provider").AccountProviderState["availability"];
  accountUnavailableReason?: import("@drora/provider").AccountProviderState["unavailableReason"];
      ...
      return [
        {
          ...
          subscriptionRenewTime: null,
          subscriptionExpireTime: null,
          // Team Plan 项目没有可用 drora-team-api-key 时，不能继续当作已启用连接方式。
