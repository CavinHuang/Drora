...
export function SavedWorkflowProjectGroup({
  ...
  const agentService = services.droraAgentService;
  ...
  const launch = useCallback(
    async (entry: DroraSavedWorkflowEntry, args: Record<string, unknown>) => {
  ...
  const handleCardPromote = useCallback(
    (entry: DroraSavedWorkflowEntry) => void handlePromote(entry),
    [handlePromote],
  );
