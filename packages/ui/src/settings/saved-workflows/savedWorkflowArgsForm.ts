...
import type { DroraSavedWorkflowArgType, DroraSavedWorkflowArgsDeclaration } from "@drora/shared";

export interface SavedWorkflowArgField {
  name: string;
  type: DroraSavedWorkflowArgType;
  description?: string;
  required: boolean;
  hasDefault: boolean;
...
function formatSavedWorkflowArgValue(type: DroraSavedWorkflowArgType, value: unknown): string {
...
export function buildSavedWorkflowArgFields(
  declaration: DroraSavedWorkflowArgsDeclaration | undefined,
...
type SavedWorkflowArgRowsCollect =
  | { ok: true; args: DroraSavedWorkflowArgsDeclaration | undefined }
...
export function rowsToArgsDeclaration(
  ...
  const args: DroraSavedWorkflowArgsDeclaration = {};
