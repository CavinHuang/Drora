...
function CodingPlanQuotaCards({
  ...
  accountAccess:
    | import("@drora/shared").DroraProviderAccountAccess
    | import("@drora/shared").DroraAccountAccess
    | undefined;
            ...
            <div key={card.key} className="min-w-0 flex-1 rounded-xl bg-surface/70 p-4">
              ...
              <div className="flex min-h-5 min-w-0 items-center gap-1">
                ...
                {card.key === "serverMcp" ? (
                  <ControlHintTooltip
                    title={intl.formatMessage({
                      id: "sidebar.usage.plan.droraMcpDescription",
                    })}
                    standalone
                  >
                    <button
                      ...
                      data-drora-mcp-info="usage-stats"
                    >
