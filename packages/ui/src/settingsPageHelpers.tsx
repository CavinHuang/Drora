...
export type { Locale, LocalePreference } from "@drora/shared";
...
const DRORA_INTERACTION_BEHAVIOR_OPTIONS: readonly DroraInteractionBehavior[] = ["queue", "guide"];
...
export function GeneralSectionContent({
  ...
  onDroraInteractionBehaviorChange,
  ...
  onDroraInteractionBehaviorChange: (behavior: DroraInteractionBehavior) => Promise<void>;
  ...
  return (
    <div className="space-y-4">
      ...
      <SettingsGroupCard>
        <SettingsRow
          label={intl.formatMessage({ id: "settings.droraInteractionBehavior" })}
          description={intl.formatMessage({
            id: "settings.droraInteractionBehaviorDescription",
          })}
          control={
            <Select
              value={droraInteractionBehavior}
              onValueChange={(value) => {
                void onDroraInteractionBehaviorChange(value as DroraInteractionBehavior);
              }}
            >
              <SelectTrigger size="lg" className="w-[260px] min-w-0 justify-between">
                <SelectValue />
              ...
              <SelectContent>
                {DRORA_INTERACTION_BEHAVIOR_OPTIONS.map((behavior) => (
                  <SelectItem key={behavior} value={behavior}>
                    {intl.formatMessage({
                      id: `settings.droraInteractionBehavior.option.${behavior}`,
                    })}
                  </SelectItem>
                ))}
              </SelectContent>
