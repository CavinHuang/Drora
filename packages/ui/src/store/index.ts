...
const CODE_PREVIEW_SETTINGS_KEY = "drora-code-preview-settings";
const PERFORMANCE_MODE_STORAGE_KEY = "drora-performance-mode";
 ...
 */
export function createDroraStore(
  ...
  const useStore = create<DroraState>()((set, get) => ({
    ...
    theme: normalizeThemePreference((readSafeLocalStorage("drora-theme") as Theme) || "zai-dark"),
    setTheme: (theme: Theme) => {
      const normalizedTheme = normalizeThemePreference(theme);
      writeSafeLocalStorage("drora-theme", normalizedTheme);
    ...
    setLocale: (locale: string) => {
      writeSafeLocalStorage("drora-locale", locale);
      set({ locale });
    },
...
export type DroraStore = ReturnType<typeof createDroraStore>;
