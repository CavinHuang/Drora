...
const MCP_CONFIG_KEY = "drora-mcp-config";
export const MCP_DELETED_PRELOAD_KEY = "drora-mcp-deleted-preload";

export const DEFAULT_MCP_CONFIG: McpConfig = {
  mcp: { mcpServers: {} },
  droraagentmcp: { mcpServers: {}, projects: {} },
};
...
export function makeServerId(
  ...
  const sourceKey =
    source === "droraagentmcp" && directorySource && directorySource !== "drora"
...
export function buildServerList(
  ...
  existingServers: DroraMcpServer[],
): DroraMcpServer[] {
  ...
  function makeServer(
    ...
    source: McpSource,
    scope: DroraMcpServer["scope"],
    enabledBySource?: boolean,
    projectPath?: string,
    file?: DroraMcpServer["file"],
    location?: DroraMcpServer["location"],
  ): DroraMcpServer {
...
export function getServerPriority(server: DroraMcpServer): number {
