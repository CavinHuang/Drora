import type { McpServerStatus, DroraMcpServer, DroraMcpServerStatusSnapshot } from "@drora/shared";
...
function mapRuntimeStatusToUi(snapshot: DroraMcpServerStatusSnapshot): MappedMcpServerStatus {
