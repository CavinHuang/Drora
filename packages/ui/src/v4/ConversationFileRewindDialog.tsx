...
import type { V4ConversationFileRewindPreviewResult } from "@drora/shared/drora-protocol-v4";
...
function formatReason(reason: string, intl: ReturnType<typeof useDroraIntl>["intl"]) {
