// sessions-index 传输面（desktop/host 实现）：桥到 IDroraAgentService 的 v4 sessions-index 转发面
...
import { sessionsIndexTopic } from "@drora/shared/drora-protocol-v4";
...
export function createAgentSessionsIndexTransport(
  ...
  const ensureHandshake = () => {
    ...
    return ensureAgentV4ConnectionHandshake(
      agentService as Pick<IDroraAgentService, "helloConversationV4" | "initializeConversationV4">,
    );
  };
