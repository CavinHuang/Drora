...
import { useToolbarConfigOptions } from "@/hooks/useDroraConfig.js";
...
function V4ComposerModelControlsImpl({
  ...
  const thoughtOption = useMemo<DroraConfigOption | null>(() => {
...
import { isApiKeyAccess } from "@drora/provider";
