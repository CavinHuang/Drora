...
//
// 旧草稿面（droraSessionStore composerDraftByScopeId + chatComposerDraftStorage 写路径）
...
import { modelSelectionSchema, type ModelSelection } from "@drora/shared";
...
const STORAGE_KEY_PREFIX = "drora-v4-composer-drafts:v1:";
