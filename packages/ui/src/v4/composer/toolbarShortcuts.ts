...
import type { ShortcutCommandId, DroraConfigOption } from "@drora/shared";
import {
...
function getChatToolbarShortcutKey(
  category: DroraConfigOption["category"],
...
interface ToolbarShortcutState {
  ...
  modelOption?: DroraConfigOption;
  modeOption?: DroraConfigOption;
  thoughtOption?: DroraConfigOption;
}
