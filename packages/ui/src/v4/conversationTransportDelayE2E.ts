import type { CommandAck } from "@drora/shared/drora-protocol-v4";
...
export async function sendWithConversationDelayE2E(
  ...
  const host =
    typeof window === "undefined"
      ? undefined
      : (window as Window & { __droraTransportDelayE2E?: DelayPlan });
  const plan = shouldExposeE2EStoreBridge() ? host?.__droraTransportDelayE2E : undefined;
