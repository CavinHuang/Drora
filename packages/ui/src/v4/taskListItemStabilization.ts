...
//
// sessions-index / Controller tasks-index 每个内容帧都会全量重建 DroraTaskMeta[]，
...
export function buildTaskListItemIdentityKey(meta: DroraTaskMeta): string {
...
export function stabilizeTaskListItems<T extends DroraTaskMeta>(previous: T[], next: T[]): T[] {
