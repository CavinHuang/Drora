...
import type { DroraGroupedTaskViewNode, DroraTaskGroupColor } from "@drora/services";
import {
...
export function GroupItem({
  ...
  getTaskRemoteSessionId: (task: DroraTaskMeta) => string | undefined;
  getTaskWorkspaceLabel: (task: DroraTaskMeta) => string;
  onSelectTask: (workspacePath: string, taskId: string, workspaceIdentity?: string) => void;
  onCloseTask: (task: DroraTaskMeta) => void;
  onOpenFileTree?: (task: DroraTaskMeta) => void;
  onCreateTask: () => void;
  ...
  onUpdateGroupColor: (groupId: string, color: DroraTaskGroupColor) => void;
  onUngroupGroup: (groupId: string) => void;
  onMoveTaskToGroup: (task: DroraTaskMeta, groupId: string | null) => void;
  onMoveTaskToTop: (task: DroraTaskMeta) => void;
  onStartRenameTask: (task: DroraTaskMeta) => void;
  onArchiveTask: (task: DroraTaskMeta) => void;
  onMarkTaskAsUnread: (task: DroraTaskMeta) => void;
  ...
  const handleGroupColorChange = useCallback(
    (color: string) => {
      onUpdateGroupColor(node.group.id, color as DroraTaskGroupColor);
    },
