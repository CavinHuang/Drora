import type { DroraTaskGroupColor } from "@drora/services";
...
const TASK_GROUP_COLOR_CLASS: Record<DroraTaskGroupColor, string> = {
...
const TASK_GROUP_BORDER_COLOR_CLASS: Record<DroraTaskGroupColor, string> = {
