...
export function n$(e = {}) {
    let n = (e.env ?? process.env).HOME?.trim() || homedir();
    return t$({
        pluginId: Lu,
...
export function dae(e) {
    return (/\braw foreground event\b.*\brefused because\b/i.test(e) ||
...
export var Ft = class extends Error {
    ...
    constructor(t = "unknown broker error", n = {}) {
        let r = (t && t.length > 0 ? t : n.code && n.code.length > 0 ? n.code : "unknown broker error") ||
            "unknown broker error", s = (n.details?.action_sent === !1 || dae(r)) && !/\baction_sent\s*=\s*false\b/i.test(r)
...
export var Mb = "ZCODE_CUA_BROKER_ALLOW_ANY_PEER", xb = "ZCODE_CUA_ALLOW_DEV_BROKER", Ob = Object.freeze(["1", "true", "yes", "on"]);
export var Xh = "broker_not_accepting", Qh = "permission_refresh_in_progress", ey = "permission_refresh_invalid", ty = "broker_response_ambiguous", ny = "caller_timeout", ry = "restart_deferred_active_turn", lae = Object.freeze({
    [Xh]: !0,
    [Qh]: !0,
    [ey]: !1,
    [ty]: !1,
...
export var mae = 30 * 1e3, s$ = 5 * 1e3;
export function Fb(e, t) {
    if (e !== "hold_key" && e !== "hold_key_to_app")
        return 0;
    let n = (t ?? {}).duration;
...
export function Bb(e, t, n) {
    if (t !== "hold_key" && t !== "hold_key_to_app")
        return e;
    let r = Fb(t, n);
...
export function Ub(e) {
    if (e === null || typeof e != "object" || Array.isArray(e))
        return !1;
    let t = e, n = t.message, r = t.code, o = t.details;
...
export function zb(e) {
    if (e !== null && typeof e == "object" && !Array.isArray(e)) {
        let t = e, n = t.code, r = typeof n == "string" && n.trim().length > 0 ? n.trim() : null, o = t.message, s = (typeof o == "string" && o.trim().length > 0 ? String(o) : null) ??
            r ??
            "unknown broker error", a = t.details !== null && typeof t.details == "object" && !Array.isArray(t.details)
            ? {
                ...t.details,
            }
            : {};
...
export var Qu = class {
    ...
    constructor(t, n) {
        ...
        if (typeof n.timeoutMs != "number" || !Number.isFinite(n.timeoutMs) || n.timeoutMs <= 0)
            throw new Error(`permission broker timeout must be a finite, positive number of milliseconds, got ${n.timeoutMs}`);
        ((this.socketPath = t),
...
export function d$(e, t, n, r) {
    let o = e instanceof Error ? e.message : String(e ?? "transport error"), s = r ?? (e instanceof Error ? e.name : typeof e == "string" ? "string" : "unknown");
