...
function runBootstrapServerBuild() {
  ...
  // bootstrap:with-remote 的最终构建过去复用 build:bootstrap，导致 @drora/server build
...
function runBootstrapWithRemoteBuild() {
  for (const filter of ["@drora/rpc", "@drora/web", "@drora/formal-proof"]) {
